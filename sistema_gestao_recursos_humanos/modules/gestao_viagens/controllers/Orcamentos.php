...
class Orcamentos extends AdminController
{
    ...
    public function index()
    {
        ...
        $data['total_orcamento'] = $this->Gv_gestao_viagem_model->total_orcamento();
		$data['total_orcamento_penedntes'] = $this->Gv_gestao_viagem_model->total_orcamento(1);
		$data['total_orcamento_rejeitados'] = $this->Gv_gestao_viagem_model->total_orcamento(3);
		$data['total_orcamento_aprovados'] = $this->Gv_gestao_viagem_model->total_orcamento(2);
    ...
    public function analise_grafica() {
        ...
        $data['orcamentos_grafico'] = $this->Gv_gestao_viagem_model->get_orcamento_grafico();

		$this->load->view('orcamentos/analise_grafica', $data);
	}
