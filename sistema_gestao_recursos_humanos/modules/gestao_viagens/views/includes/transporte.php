                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo admin_url('gestao_viagens/pedidos/status_transporte_aprovar/'.$c['id']); ?>"
                                    class="btn btn-success text-white"
                                    style="color:#fff;">
                                    Aprovar
                                </a>
                                <a onclick="return confirm('Tens certteza que desejas rejeitar este Voo?');"
                                    href="<?php echo admin_url('gestao_viagens/pedidos/status_transporte_rejeitar/'.$c['id']); ?>"
                                ...
                                <a href="javascript:;" data-id="<?= $c['id'] ?>"
                                    ...
                                    class="btn btn-default btn-icon btn_edit_transporte"
                                    style="background-color: #007bff; border-color: #007bff; color: white;">
                                    <i class="fa fa-edit"></i>
                                </a>

                                <a onclick="return confirm('Tens certteza que desejas eliminar esta Transporte?');"
                                    href="<?php echo admin_url('gestao_viagens/pedidos/delete_transporte/'.$c['id']); ?>"
                                    class="btn btn-danger btn-icon _delete"><i class="fa fa-trash" style="color:white;"></i></a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
...
<div class="modal" id="modal_add" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-md">
        <?= form_open(admin_url('gestao_viagens/pedidos/add_transporte'), array('method' => 'post')) ?>
...
<?= form_open(admin_url('gestao_viagens/pedidos/editar_transporte'), array('method' => 'post', 'id' => 'form_edit_transporte')) ?>
