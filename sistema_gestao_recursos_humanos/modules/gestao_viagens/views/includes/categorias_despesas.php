...
<div>
    ...
    <table class="table dt-table">
        <thead>
            <th width="30%"><?php echo _l('Categoria'); ?></th>
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo html_entity_decode($c['categoria']); ?></td>
                ...
                <td>
                    ...
                    <a href="javascript:;" data-id="<?= $c['id'] ?>"
                        data-categoria="<?= html_entity_decode($c['categoria']) ?>"
                        data-descricao="<?= html_entity_decode($c['descricao']) ?>"
                        class="btn btn-default btn-icon btn_edit_categoria_despesa">
                    ...
                    <a onclick="return confirm('Tens certteza que desejas eliminar esta categoria?');"
                        href="<?php echo admin_url('gestao_viagens/delete_categoria_despesa/'.$c['id']); ?>"
    ...
    <div class="modal" id="modal_add" tabindex="-1" role="dialog">
        <div class="modal-dialog w-25">
            <?= form_open(admin_url('gestao_viagens/add_categoria_despesa'), array('method' => 'post')) ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form">
                                <div class="col-md-12">
                                    <?php echo render_input('categoria','Categoria'); ?>
                                </div>
                                <div class="col-md-12">
    ...
    <?= form_open(admin_url('politicas_empresa/editar_categoria_despesa'), array('method' => 'post', 'id' => 'form_edit_categoria')) ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form">
                                <div class="col-md-12">
                                    <?php echo render_input('e_categoria','Categoria'); ?>
                                </div>
                                <div class="col-md-12">
