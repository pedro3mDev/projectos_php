...
<div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="javascript:;" data-id="<?= $c['id'] ?>"
                        data-status="<?= html_entity_decode($c['status']) ?>"
                        data-descricao="<?= html_entity_decode($c['descricao']) ?>"
                        class="btn btn-default btn-icon btn_edit_status">
                    ...
                    <a onclick="return confirm('Tens certteza que desejas eliminar esta status?');"
                        href="<?php echo admin_url('gestao_viagens/delete_status/'.$c['id']); ?>"
    ...
    <div class="modal" id="modal_add" tabindex="-1" role="dialog">
        <div class="modal-dialog w-25">
            <?= form_open(admin_url('gestao_viagens/add_status'), array('method' => 'post')) ?>
