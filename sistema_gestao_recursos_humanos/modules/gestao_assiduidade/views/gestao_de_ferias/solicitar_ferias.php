    ...
    <div class="row">
                  ...
                  <div class="row">
                        <div class="col-md-6">
                           <div class="alert alert-warning" role="alert">
                              ...
                              <p>Saudações prezado, o limite máximo de dias de férias atual que foi estabelecido no sitema é de <?php echo get_conf_gestao_ferias()->limite_dias_ferias;  ?> dias.</p>
                           </div>
                        </div>
                     </div>
                     <!--End Alerts-->
                  ...
                  <div class="row">
                    ...
                    <div class="">
                            ...
                            ?>
                            <form action="<?php echo admin_url('gestao_assiduidade/gestao_de_ferias_geral?group=solicitar_ferias'); ?>" id="filtros_select">
                              ...
                              <div class="col-md-3" style="margin-top: 22px; margin-bottom: 22px">
                                       ...
                                       <select name="funcao_id" class="selectpicker"  id="funcao_id" data-width="100%" data-actions-box="true" data-live-search="true" data-none-selected-text=""> 
                                          <option value="0">Nada selecionado</option>          
                                       </select>	
                              </div>
                              ...
                              <div class="col-md-3" style="margin-top: 22px; margin-bottom: 22px">
                                       ...
                                       <select name="estado" class="selectpicker"  id="estado" data-width="100%" data-actions-box="true" data-live-search="true" data-none-selected-text=""> 
                                          <option value="0">Nada selecionado</option>    
                                          <option value="P" <?php if($filtros['estado']=='P'){ echo "selected";} ?>>Pendente</option>  
                                          <option value="A" <?php if($filtros['estado']=='A'){ echo "selected";} ?>>Aprovado</option>  
                                          <option value="R" <?php if($filtros['estado']=='R'){ echo "selected";} ?>>Rejeitado</option>
                                          <option value="E" <?php if($filtros['estado']=='E'){ echo "selected";} ?>>Em uso</option>            
                                       </select>	
                              </div>
      ...
      <div class="modal-body">
         ...
         <form action="<?php echo admin_url('gestao_assiduidade/add_gestao_ferias'); ?>" id="form_add">
            ...
            <div class="col-md-12" style="">
                                       ...
                                       <select name="func_id" class="selectpicker"  id="func_id" data-width="100%" data-actions-box="true" data-live-search="true" data-none-selected-text=""> 
                                          <option value="0">Nada selecionado</option>
                                          <?php 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         ...
         <form action="<?php echo admin_url('gestao_assiduidade/add_gestao_ferias'); ?>" id="form_add">
            ...
            <div class="col-md-12" style="">
                                       <label for=""><?php echo _l('Funcionário'); ?></label>
                                       <select name="func_id" class="selectpicker"  id="e_func_id" data-width="100%" data-actions-box="true" data-live-search="true" data-none-selected-text=""> 
                                          <option value="0">Nada selecionado</option>
                                          <?php 
                                             foreach ($opt_func as $value) { ?>
                                                <option value="<?php echo new_html_entity_decode($value['staffid']); ?>"><?php echo new_html_entity_decode($value['firstname'].' '.$value['lastname']); ?></option>
