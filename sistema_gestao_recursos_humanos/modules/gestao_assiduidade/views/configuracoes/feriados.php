...
<div>
				...
				<tr>
					...
					<td>
						<?php if(is_admin() || has_permission('hrm_setting','','edit')){ ?>
							<a data-id="<?php echo $value['id'];?>" data-nome="<?php echo $value['nome'];?>" data-data_inicial="<?php echo  $value['data_inicial'];?>"  data-data_final="<?php echo  $value['data_final'];?>"    href="#"  class="btn btn-default btn-icon btn_edit_feriados"><i class="fa fa-edit"></i></a>
						<?php } ?>

						<?php if(is_admin() || has_permission('hrm_setting','','delete')){ ?>
							<a href="<?php echo admin_url('gestao_assiduidade/delete_periodos/'.$value['id']); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
						<?php } ?>
	...
	<div class="modal" id="modal_add" tabindex="-1" role="dialog">
		<div class="modal-dialog w-25">
		    <form method="post" action="<?php echo admin_url('gestao_assiduidade/add_feriados'); ?>">
						...
						<div class="col-md-12">
							...
							<div class="form">
								...
								<div class="col-md-12">
									 ...
									 <input name="data_inicial" type="date" class="form-control" required>
								</div>
								<div class="col-md-12">
									 <label for="">Data Final</label>
									 <input name="data_final" type="date" class="form-control" required>
								</div>
	...
	<form method="post" action="<?php echo admin_url('gestao_assiduidade/edit_feriados'); ?>">
     <?php echo form_hidden($this->security->get_csrf_token_name(), $this->security->get_csrf_hash()); ?>
					...
					<div class="row">
						...
						<input name="id" id="id" type="hidden" required>
						    <div class="form">
								...
								<div class="col-md-12">
									 <label for="">Data inicial</label>
									 <input name="data_inicial" id="data_inicial" type="date" class="form-control">
								</div>
								<div class="col-md-12">
									 <label for="">Data Final</label>
