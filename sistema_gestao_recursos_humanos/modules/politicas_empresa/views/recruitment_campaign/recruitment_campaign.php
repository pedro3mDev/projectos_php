      ...
      <div class="row">
        <div class="col-md-12">
          <a class="dashboard-link" href="" style="font-size: 16px; color: #333;">
            Recrutamento e Selecção / Campanha de Recrutamento
          </a>
        </div>
      </div>
      </br>
            ...
            <div class="modal-body">
               ...
               <div class="tab-content">
                  <div role="tabpanel" class="tab-pane active" id="general_infor">
                    ...
                    <div class="col-md-6"> <?php echo render_date_input('cp_from_date', 'Data Inicial', ''); ?></div>
                    ...
                    <div class="col-md-6">
                      <label for="cp_manager"><small class="req text-danger">* </small> <?php echo _l('manager'); ?></label>
                      <select name="cp_manager[]" id="manager" class="selectpicker" multiple="true" data-actions-box="true" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>"  required>
                    ...
                    <div class="col-md-6">
                      <label for="cp_follower"><small class="req text-danger">* </small> <?php echo _l('follower'); ?></label>
                      <select name="cp_follower[]" id="follower" class="selectpicker" multiple="true" data-actions-box="true" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>"  required>
