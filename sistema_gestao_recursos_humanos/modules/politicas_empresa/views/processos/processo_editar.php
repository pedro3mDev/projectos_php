        ...
        <div class="row">
            <div class="col-md-6">
                <a class="dashboard-link" href=""
                    ...
                    Politicas de Empresa / Processos / Editar
                </a>
            </div>
            <div class="col-md-6"
            ...
            <div class="col-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <?= form_open_multipart(admin_url('politicas_empresa/processos/actualizar_processo/'.$processo['id']), array('method' => 'post')) ?>
                        <div class="form">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="staff" id="staff" data-live-search="true" class="selectpicker"
                                        ...
                                        <option value="<?php echo html_entity_decode($t['staffid']); ?>"
                                            <?php if($t['staffid'] == $processo['colaborador_id']) { echo 'selected'; } ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="politica" id="politica" data-live-search="true" class="selectpicker"
                                        ...
                                        <option value="<?php echo html_entity_decode($t['id']); ?>"
                                            <?php if($t['id'] == $processo['politica_id']) { echo 'selected'; } ?>>
                            ...
                            <div class="col-md-12">
                                <?php echo render_input('titulo','Titulo<span class="text-danger">*<span>', $processo['titulo']); ?>
                            </div>
                            <div class="col-md-12">
                                <?php echo render_textarea('descricao', 'Descrição<span class="text-danger">*<span>', $processo['descricao']) ?>
                            </div>
                            <div class="col-md-12">
                                <?php echo render_input('data_verificacao','Data Verificação<span class="text-danger">*<span>', $processo['data_verificacao'], 'date'); ?>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <?php
                                echo render_select('aprovadores[]', $staff_list, ['staffid', ['firstname', 'lastname']], 'Aprovadores<span class="text-danger">*</span>', (json_decode($processo['aprovadores'] ?? '')), ['multiple' => true], [], '', '', false);
                                ?>
                            </div>
                            <div class="col-md-12">
