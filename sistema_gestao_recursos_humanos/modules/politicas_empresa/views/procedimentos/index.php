        ...
        <div class="row">
            <div class="col-md-6">
                <a class="dashboard-link" href=""
                    ...
                    Politicas de Empresa / Procedimentos  
                </a>
            </div>
            <div class="col-md-6"
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <table class="table dt-table">
                            <thead>
                                <th><?php echo _l('pe_procedimentos'); ?></th>
                                <th><?php echo _l('tipo_procedimento'); ?></th>
                            ...
                            <tbody>
                                <?php foreach($procedimentos as $c){ ?>
                                <tr>
                                    <td><?php echo html_entity_decode($c['procedimento']); ?></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= admin_url('politicas_empresa/procedimentos/procedimento/'. $c['id']); ?>"
                                        ...
                                        <a href="<?= admin_url('politicas_empresa/procedimentos/procedimento_editar/'. $c['id']); ?>"
                                        ...
                                        <a onclick="return confirm('Tens certteza que desejas eliminar esta politica?');"
                                            href="<?php echo admin_url('politicas_empresa/procedimentos/delete_procedimento/'.$c['id']); ?>"
...
<div class="modal" id="modal_add" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <?= form_open_multipart(admin_url('politicas_empresa/procedimentos/add_procedimento'), array('method' => 'post')) ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form">
                            ...
                            <div class="col-md-12">
                                <?php echo render_input('procedimento','Procedimento<span class="text-danger">*<span>'); ?>
                            </div>
                            <div class="col-md-12">
