    ...
    <div class="content">
            ...
            <div class="col-md-12" >
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a  style="color:#333; font-size:16px;" href="">Nova Categória</a></li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="md:tw-flex md:tw-gap-6">
            <div class="tw-mt-12 md:tw-mt-0 tw-w-full tw-mx-auto tw-max-w-4xl">
                <?php echo form_open(admin_url('politicas_empresa/seguranca_escritorio/adicionar_categoria'), array('method' => 'post')); ?>
                <div class="panel_s">
                                        ...
                                        <div class="horizontal-scrollable-tabs panel-full-width-tabs">
                                            ...
                                            <div class="horizontal-tabs">
                                                <ul class="nav nav-tabs customer-profile-tabs nav-tabs-horizontal"
                                                    ...
                                                    data-toggle="tab"><?php  $title ?>Detalhes de Categória</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                    ...
                    <div class="text-right panel-footer tw-space-x-1" id="profile-save-section">
                        <button class="btn" style="background-color: #007bff; border-color: #007bff; color: white;"> Adicionar </button>
                    </div>
                </div>
                <?php echo form_close() ?>
            </div>
