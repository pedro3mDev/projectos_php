                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= admin_url('politicas_empresa/conformidades/conformidade/'. $c['id']); ?>"
                                        class="btn btn-success btn-icon">
                                        <i style="color:#fff;" class="fa fa-eye"></i>
                                        </a>
                                        <?php } ?>
                                        <?php if(is_admin() || has_permission('plp_configuracoes','','edit')){ ?>
                                        <a href="<?= admin_url('politicas_empresa/conformidades/conformidade_editar/'. $c['id']); ?>"
                                        ...
                                        <a onclick="return confirm('Tens certteza que desejas eliminar esta politica?');"
                                            href="<?php echo admin_url('politicas_empresa/conformidades/delete_conformidade/'.$c['id']); ?>"
                                            class="btn btn-danger btn-icon _delete"><i style="color:#fff;" class="fa fa-trash"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                                <?php } ?>
...
<div class="modal" id="modal_add" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <?= form_open_multipart(admin_url('politicas_empresa/conformidades/add_conformidade'), array('method' => 'post')) ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form">
                            ...
                            <div class="col-md-12">
                                <?php echo render_textarea('observacao', 'Observação<span class="text-danger">*<span>', '') ?>
                            </div>
                            <div class="col-md-12">
