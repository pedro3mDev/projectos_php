    ...
    <div class="content">
            ...
            <div class="col-12">
                <div class="tw-mb-6">
                    <div class="tw-mb-3">
                        ...
                        <a href="<?php echo admin_url('politicas_empresa/politicas_confidencialidade'); ?>">
                            <?php echo _l('pe_politicas_confidencialidade'); ?> →
                        </a>
        ...
        <div class="md:tw-flex md:tw-gap-6">
            <div class="tw-mt-12 md:tw-mt-0 tw-w-full tw-mx-auto tw-max-w-4xl">
                <?php echo form_open_multipart(admin_url('politicas_empresa/politicas_confidencialidade/actualizar_termo/'.$confidencialidade['id'])); ?>
                <div class="panel_s">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group" app-field-wrapper="titulo">
                                                            ...
                                                            <select class="form-control" name="colaborador"
                                                                ...
                                                                <option value="<?= $colaborador['staffid'] ?>"
                                                                    <?php if ($confidencialidade['staff_id'] == $colaborador['staffid']) { echo 'selected'; } ?>>
                                                        ...
                                                        <div class="form-group" app-field-wrapper="politica">
                                                            ...
                                                            <select class="form-control" name="politica" id="politica">
                                                                ...
                                                                <option value="<?= $politica['id'] ?>"
                                                                    <?php if ($confidencialidade['politica_id'] == $politica['id']) { echo 'selected'; } ?>>
                                                                    <?= $politica['titulo'] ?>
                                                                </option>
                                                                <?php endforeach ?>
                                                            </select>
                                                        ...
                                                        <div class="form-group" app-field-wrapper="data_assinatura">
                                                            ...
                                                            <input type="date" id="data_assinatura"
                                                                ...
                                                                value="<?= $confidencialidade['data_assinatura'] ?>">
                                                        </div>
                                                        <div class="form-group" app-field-wrapper="tipo_assinatura">
                                                            ...
                                                            <select class="form-control" name="tipo_assinatura"
                                                                ...
                                                                <option value=""></option>
                                                                <option value="fisico"
                                                                    <?php if ($confidencialidade['tipo_assinatura'] == 'fisico') { echo 'selected'; } ?>>
                                                                    Fisico</option>
                                                                <option value="digital"
                                                                    <?php if ($confidencialidade['tipo_assinatura'] == 'digital') { echo 'selected'; } ?>>
                                                                    Digital</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group" app-field-wrapper="arquivo">
                                                            ...
                                                            <?php if (!empty($confidencialidade['arquivo'])) : ?>
                                                            <h5>Anexo</h5>
                                                            <a target="_blank"
                                                                href="<?= base_url('modules/politicas_empresa/uploads/'.$confidencialidade['arquivo']); ?>"><?= $politica['arquivo']; ?></a>
                                                            <?php else : ?>
                                                            <?php endif ?>
                                                        </div>
                                                    </div>
