        ...
        <div class="row">
            <div class="col-md-6">
                <a class="dashboard-link" href=""
                    ...
                    Politicas de Empresa / Comunicações 
                </a>
            </div>
            <div class="col-md-6"
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table dt-table">
                            <thead>
                                ...
                                <th><?php echo _l('pe_data_verificacao'); ?>
                                </th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo html_entity_decode($c['firstname_c'] .' '.$c['lastname_c']); ?>
                                    </td>
                                    <td><?php echo html_entity_decode($c['titulo']); ?>
                                    </td>
                                    <td><?php echo html_entity_decode($c['data_verificacao']); ?>
                                    </td>
                                    <td><?php echo html_entity_decode($c['status']); ?>
                                    </td>
                                    <td>
                                        <?php if(is_admin() || has_permission('plp_configuracoes','','view')){ ?>
                                        <a href="<?= admin_url('politicas_empresa/comunicacoes/comunicacao/'. $c['id']); ?>"
                                        ...
                                        <a href="<?= admin_url('politicas_empresa/comunicacoes/comunicacao_editar/'. $c['id']); ?>"
                                        ...
                                        <a onclick="return confirm('Tens certteza que desejas eliminar esta politica?');"
                                            href="<?php echo admin_url('politicas_empresa/comunicacoes/delete_comunicacao/'.$c['id']); ?>"
...
<div class="modal" id="modal_add" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <?= form_open_multipart(admin_url('politicas_empresa/comunicacoes/add_comunicacao'), array('method' => 'post')) ?>
                        ...
                        <div class="form">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="staff"
                                        class="control-label"><?php echo _l('staff'); ?><span
                                    ...
                                    <select name="staff" id="staff"
                                        ...
                                        <option
                                            value="<?php echo html_entity_decode($t['staffid']); ?>">
