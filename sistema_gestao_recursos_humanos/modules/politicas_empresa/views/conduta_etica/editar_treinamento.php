    ...
    <div class="content">
        ...
        <div class="md:tw-flex md:tw-gap-6">
            <div class="tw-mt-12 md:tw-mt-0 tw-w-full tw-mx-auto tw-max-w-4xl">
                <?php echo form_open(admin_url('politicas_empresa/conduta_etica/actualizar_treinamento/'.$treinamento['id']), array('method' => 'post')); ?>
                <div class="panel_s">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group" app-field-wrapper="conduta">
                                                            ...
                                                            <select class="form-control" name="conduta" id="conduta">
                                                                ...
                                                                <option value="<?= $conduta['id'] ?>"
                                                                    <?php if ($treinamento['conduta_id'] == $conduta['id']) { echo 'selected'; } ?>>
                                                                    <?= $conduta['nome'] ?></option>
                                                                <?php endforeach ?>
                                                            </select>
                                                        </div>
                                                        <div class="form-group" app-field-wrapper="data">
                                                            ...
                                                            <input type="date" id="data" name="data"
                                                                class="form-control"
                                                                value="<?= $treinamento['data_treinamento'] ?>">
                                                        </div>
                                                        <div class="form-group" app-field-wrapper="estado">
                                                            ...
                                                            <select class="form-control" name="estado" id="estado">
                                                                <option value="pendente"
                                                                    <?php if ($treinamento['status'] == 'pendnte') { echo 'selected'; } ?>>
                                                                    Pendente</option>
                                                                <option value="activo"
                                                                    <?php if ($treinamento['status'] == 'ativo') { echo 'selected'; } ?>>
                                                                    Ativo</option>
                                                                <option value="finalizado"
                                                                    <?php if ($treinamento['status'] == 'finalizado') { echo 'selected'; } ?>>
                                                                    Finalizado</option>
                                                            </select>
                                                        </div>
                                                    </div>
