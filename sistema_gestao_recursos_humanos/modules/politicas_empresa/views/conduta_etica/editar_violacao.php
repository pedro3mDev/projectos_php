    ...
    <div class="content">
        ...
        <div class="md:tw-flex md:tw-gap-6">
            <div class="tw-mt-12 md:tw-mt-0 tw-w-full tw-mx-auto tw-max-w-4xl">
                <?php echo form_open_multipart(admin_url('politicas_empresa/conduta_etica/actualizar_violacao/'.$violacao['id']), array('method' => 'post')); ?>
                <div class="panel_s">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group" app-field-wrapper="conduta">
                                                            ...
                                                            <select class="form-control" name="conduta" id="conduta">
                                                                ...
                                                                <option value="<?= $conduta['id'] ?>"
                                                                    <?php if ($violacao['conduta_id'] == $conduta['id']) { echo 'selected'; } ?>>
                                                                    <?= $conduta['nome'] ?></option>
                                                                <?php endforeach ?>
                                                            </select>
                                                        </div>
                                                        <div class="form-group" app-field-wrapper="staff">
                                                            ...
                                                            <select class="form-control" name="staff" id="staff">
                                                                ...
                                                                <option value="<?= $staff['staffid'] ?>"
                                                                    <?php if ($violacao['staff_id'] == $staff['staffid']) { echo 'selected'; } ?>>
                                                                    <?= $staff['firstname'] .' '.$staff['lastname'] ?>
                                                                </option>
                                                                <?php endforeach ?>
                                                            </select>
                                                        </div>
                                                        <div class="form-group" app-field-wrapper="acao_tomada">
                                                            <label for="acao_tomada" class="control-label">
                                                                Ação Tomada<small class="req text-danger">*</small>
                                                            </label>
                                                            <input type="text" id="acao_tomada" name="acao_tomada"
                                                                value="<?= $violacao['acao_tomada'] ?>"
                                                                class="form-control">
                                                        </div>
                                                        <div class="form-group" app-field-wrapper="data_ocorrencia">
                                                            <label for="data_ocorrencia" class="control-label">
                                                                Data da Ocorrência<small
                                                                    class="req text-danger">*</small>
                                                            </label>
                                                            <input type="date" id="data_ocorrencia"
                                                                value="<?= $violacao['data_ocorrencia'] ?>"
                                                                name="data_ocorrencia" class="form-control">
                                                        </div>
                                                        <div class="form-group" app-field-wrapper="estado">
                                                            ...
                                                            <select class="form-control" name="estado" id="estado">
                                                                <option value="ativo"
                                                                    <?php if ($violacao['status'] == 'ativo') { echo 'selected'; } ?>>
                                                                    Ativo</option>
                                                                <option value="resolvido"
                                                                    <?php if ($violacao['status'] == 'resolvido') { echo 'selected'; } ?>>
                                                                    Resolvido</option>
                                                            </select>
                                                        </div>
                                                    </div>
