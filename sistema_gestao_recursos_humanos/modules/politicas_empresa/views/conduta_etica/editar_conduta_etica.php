    ...
    <div class="content">
        ...
        <div class="md:tw-flex md:tw-gap-6">
            <div class="tw-mt-12 md:tw-mt-0 tw-w-full tw-mx-auto tw-max-w-4xl">
                <?php echo form_open(admin_url('politicas_empresa/conduta_etica/actualizar_conduta/'.$conduta['id']), array('method' => 'post')); ?>
                <div class="panel_s">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group" app-field-wrapper="titulo">
                                                            ...
                                                            <input type="text" id="titulo" name="titulo"
                                                                class="form-control" value="<?= $conduta['nome'] ?>">
                                                        </div>
                                                        <div class="form-group" app-field-wrapper="descricao">
                                                            ...
                                                            <textarea name="descricao" class="form-control"
                                                                style="min-height: 100px;"><?= $conduta['descricao'] ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
