    ...
    <div class="content">
        ...
        <div class="md:tw-flex md:tw-gap-6">
            <div class="tw-mt-12 md:tw-mt-0 tw-w-full tw-mx-auto tw-max-w-4xl">
                <?php echo form_open_multipart(admin_url('politicas_empresa/conduta_etica/adicionar_violacao/'), array('method' => 'post')); ?>
                <div class="panel_s">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group" app-field-wrapper="data_ocorrencia">
                                                            ...
                                                            <input type="date" id="data_ocorrencia"
                                                                value="<?= set_value('data_ocorrencia') ?>"
                                                        ...
                                                        <div class="form-group" app-field-wrapper="estado">
                                                            ...
                                                            <select class="form-control" name="estado" id="estado">
                                                                ...
                                                                <option value="resolvido"
                                                                    <?php if (set_value('estado') == 'resolvido') { echo 'selected'; } ?>>
                                                                    Resolvido</option>
                                                            </select>
                                                        </div>
                                                    </div>
