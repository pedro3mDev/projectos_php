...
<div>
    ...
    <table class="table dt-table">
        ...
        <tbody>
            <?php foreach($niveis as $c){ ?>
            <tr>
                <td><?php echo html_entity_decode($c['nivel_risco']); ?></td>
                <td><?= limitarPalavra(html_entity_decode($c['descricao']), 30); ?></td>
                <td>
                    <?php if(is_admin() || has_permission('plp_configuracoes','','edit')){ ?>
                    <a data-id="<?= $c['id'] ?>" data-nivel_risco="<?= html_entity_decode($c['nivel_risco']) ?>"
                        data-descricao="<?= html_entity_decode($c['descricao']);?>" href="javascript:;"
                        class="btn btn-default btn-icon btn_edit_nivel_risco">
                        <i class="fa fa-edit"></i>
                    </a>
                    <?php } ?>

                    <?php if(is_admin() || has_permission('plp_configuracoes','','delete')){ ?>
                    <a onclick="return confirm('Tens certteza que desejas eliminar esta nivel_risco?');"
                        href="<?php echo admin_url('politicas_empresa/delete_nivel_risco/'.$c['id']); ?>"
    ...
    <div class="modal" id="modal_add" tabindex="-1" role="dialog">
        <div class="modal-dialog w-25">
            <?= form_open(admin_url('politicas_empresa/add_nivel_risco'), array('method' => 'post')) ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form">
                                <div class="col-md-12">
                                    <?php echo render_input('nivel_risco','nivel_risco'); ?>
                                </div>
                                <div class="col-md-12">
    ...
    <?= form_open(admin_url('politicas_empresa/editar_nivel_risco'), array('method' => 'post', 'id' => 'form_edit_nivel_risco')) ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form">
                                <div class="col-md-12">
                                    <?php echo render_input('e_nivel_risco','nivel_risco'); ?>
                                </div>
                                <div class="col-md-12">
