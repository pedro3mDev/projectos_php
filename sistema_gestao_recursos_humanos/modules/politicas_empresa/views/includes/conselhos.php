...
<div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a data-id="<?= $c['id'] ?>" data-conselho="<?= html_entity_decode($c['nome']) ?>"
                        href="javascript:;" class="btn btn-default btn-icon btn_edit_conselho">
                    ...
                    <a onclick="return confirm('Tens certteza que desejas eliminar esta conselho?');"
                        href="<?php echo admin_url('politicas_empresa/delete_conselho/'.$c['id']); ?>"
    ...
    <div class="modal" id="modal_add" tabindex="-1" role="dialog">
        <div class="modal-dialog w-25">
            <?= form_open(admin_url('politicas_empresa/add_conselho'), array('method' => 'post')) ?>
    ...
    <?= form_open(admin_url('politicas_empresa/editar_conselho'), array('method' => 'post', 'id' => 'form_edit_conselho')) ?>
