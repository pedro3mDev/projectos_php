...
<div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a data-id="<?= $c['id'] ?>" data-categoria="<?= html_entity_decode($c['categoria']) ?>"
                    ...
                    <a onclick="return confirm('Tens certteza que desejas eliminar esta categoria?');"
                        href="<?php echo admin_url('politicas_empresa/delete_categoria/'.$c['id']); ?>"
    ...
    <div class="modal" id="modal_add" tabindex="-1" role="dialog">
        <div class="modal-dialog w-25">
            <?= form_open(admin_url('politicas_empresa/add_categoria'), array('method' => 'post')) ?>
    ...
    <?= form_open(admin_url('politicas_empresa/editar_categoria'), array('method' => 'post', 'id' => 'form_edit_categoria')) ?>
