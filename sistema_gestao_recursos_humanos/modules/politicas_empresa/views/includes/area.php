...
<div>
    ...
    <table class="table dt-table">
        <thead>
            <th width="30%"><?php echo _l('area'); ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo html_entity_decode($c['area']); ?></td>
                <td><?= limitarPalavra(html_entity_decode($c['descricao']), 30); ?></td>
                <td>
                    <?php if(is_admin() || has_permission('plp_configuracoes','','edit')){ ?>
                    <a data-id="<?= $c['id'] ?>" data-area="<?= html_entity_decode($c['area']) ?>"
                        data-descricao="<?= html_entity_decode($c['descricao']);?>" href="javascript:;"
                        class="btn btn-default btn-icon btn_edit_area">
                        <i class="fa fa-edit"></i>
                    </a>
                    <?php } ?>

                    <?php if(is_admin() || has_permission('plp_configuracoes','','delete')){ ?>
                    <a onclick="return confirm('Tens certteza que desejas eliminar esta area?');"
                        href="<?php echo admin_url('politicas_empresa/delete_area/'.$c['id']); ?>"
    ...
    <div class="modal" id="modal_add" tabindex="-1" role="dialog">
        <div class="modal-dialog w-25">
            <?= form_open(admin_url('politicas_empresa/add_area'), array('method' => 'post')) ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form">
                                <div class="col-md-12">
                                    <?php echo render_input('area','area'); ?>
                                </div>
                                <div class="col-md-12">
    ...
    <?= form_open(admin_url('politicas_empresa/editar_area'), array('method' => 'post', 'id' => 'form_edit_area')) ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form">
                                <div class="col-md-12">
                                    <?php echo render_input('e_area','area'); ?>
                                </div>
                                <div class="col-md-12">
