...
<div id="wrapper">
    <div class="content">
        ...
        <?php require 'modules/gestao_formacao/views/dashboard/cards.php'; ?>
        </br>
        <!-- Aqui vais por os Graficos-->
        <?php require 'modules/gestao_formacao/views/dashboard/graficos.php'; ?>
        </br>
        <!-- Aqui vais por os Scripts dos Graficos-->
        <?php require 'modules/gestao_formacao/assets/js/graficos.php'; ?>
        </br>
