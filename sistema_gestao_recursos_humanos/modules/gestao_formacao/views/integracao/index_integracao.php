...
<div id="wrapper">
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-10">
                <a class="dashboard-link" href="" style="font-size: 16px; color: #333;">
                    Gestão da Formação / Integração / Recrutamento
                </a>
            </div>
        ...
        <?php require 'modules/gestao_formacao/views/integracao/cards.php'; ?>
        </br>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class=" col-md-12">
                                ...
                                <a href="<?php echo admin_url('gestao_formacao/integracao_Avaliacao_desempenho')?>"
                        ...
                        <table class="table table-hover table-bordered table-responsive dt-table">
                            <thead class="thead-custom">
                                <th>Funcionário</th>
                                <th>Vaga (Curso e Carga Horária)</th>
                                <th>Estado</th>
                                <th></th>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo admin_url('gestao_formacao/recrutamento_aprovar/'.$item['id']); ?>"
                                            class="btn btn-success" style="color: white;">
                                            Aprovar
                                        </a>
                                        <a onclick="return confirm('Tens certteza que desejas rejeitar?');"
                                            href="<?php echo admin_url('gestao_formacao/recrutamento_rejeitar/'.$item['id']); ?>"
                                            class="btn btn-danger" style="color: white;">
                                            Rejeitar
                                        </a>
                                        <?php endif ?>
                                        <a href="<?php echo admin_url('gestao_formacao/integracao_visualizar_recrutameto')?>"
                                            class="btn btn-sucess btn-icon"
                                            style="background-color: #28a745; border-color: #28a745; color: white;">
                                            <i style="color:#fff;" class="fa fa-eye"></i>
                                        </a>
                                        <a href="javascript:;" data-id="<?php echo $item['id']; ?>"
                                            data-vaga="<?php echo $item['vaga_id']; ?>"
                                            data-staff="<?php echo $item['staff_id']; ?>"
                                            data-aprovadores='<?= html_entity_decode(($item["aprovadores"] ?? "")) ?>'
                                            class="btn btn-default btn-icon btn_edit_recrutamento"
                                            style="background-color: #007bff; border-color: #007bff; color: white;">
                                            <i style="color:#fff;" class="fa fa-edit"></i>
                                        </a>
                                        <a onclick="return confirm('Tens certteza que desejas eliminar este Recrutamento?');"
                                            href="<?php echo admin_url('gestao_formacao/delete_recrutamento/'.$item['id']); ?>"
...
<div class="modal" id="modal_add" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-md">
        <?php echo form_open(admin_url('gestao_formacao/add_recrutamento'), array('method' => 'post')); ?>
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                    <span aria-hidden="true">&times;</span>
                </button>
                <h4 class="modal-title">Novo Recrutamento</h4>
            </div>
...
<?= form_open(admin_url('gestao_formacao/editar_recrutamento'), array('method' => 'post', 'id' => 'form_edit_recrutamento')) ?>
...
<?php init_tail(); ?>
<script>
$('.btn_edit_recrutamento').click(function() {
    let staff = $(this).attr('data-staff');
    let vaga = $(this).attr('data-vaga');
    let aprovadores = $(this).attr('data-aprovadores');
    let id = $(this).attr('data-id');

    let url = "<?= admin_url('gestao_formacao/editar_recrutamento') ?>/" + id;
    $('#form_edit_recrutamento').attr('action', url);
