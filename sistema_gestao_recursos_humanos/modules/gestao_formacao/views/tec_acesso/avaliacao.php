        ...
        <div class="row">
            <div class="col-md-10">
                <a class="dashboard-link" href="" style="font-size: 16px; color: #333;">
                    Gestão da Formação / Tecnologias de Acesso / Avaliação de Desempenho
                </a>
            </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class=" col-md-12">
                                ...
                                <a href="<?php echo admin_url('gestao_formacao/tec_acesso')?>" class="btn"
                        ...
                        <table class="table table-hover table-bordered table-responsive dt-table">
                            ...
                            <tbody>
                                <?php foreach($acessibilidade as $item) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo admin_url('gestao_formacao/acessibilidade_aprovar/'.$item['id']); ?>"
                                            class="btn btn-success" style="color: white;">
                                            Aprovar
                                        </a>
                                        <a onclick="return confirm('Tens certteza que desejas rejeitar?');"
                                            href="<?php echo admin_url('gestao_formacao/acessibilidade_rejeitar/'.$item['id']); ?>"
                                            class="btn btn-danger" style="color: white;">
                                            Rejeitar
                                        </a>
                                        <?php endif ?>
                                        <a href="<?php echo admin_url('gestao_formacao/tec_acesso_visualizar_avaliacao')?>"
                                        ...
                                        <a href="javascript:;" data-id="<?= html_entity_decode($item['id'] ?? '') ?>"
                                            ...
                                            class="btn btn-default btn-icon btn_edit_acessibilidade"
                                            style="background-color: #007bff; border-color: #007bff; color: white;">
                                            <i style="color:#fff;" class="fa fa-edit"></i>
                                        </a>
                                        <a onclick="return confirm('Tens certteza que desejas eliminar esta Acessibilidade?');"
                                            href="<?php echo admin_url('gestao_formacao/delete_acessibilidade/'.$item['id']) ?>"
...
<div class="modal" id="modal_add" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('gestao_formacao/add_acessibilidade'), array('method' => 'post')); ?>
...
<?= form_open(admin_url('gestao_formacao/editar_acessibilidade'), array('method' => 'post', 'id' => 'form_edit_acessibilidade')) ?>
...
<?php init_tail(); ?>
<script>
$('.btn_edit_acessibilidade').click(function() {
    ...
    let url = "<?= admin_url('gestao_formacao/editar_acessibilidade') ?>/" + id;
    $('#form_edit_acessibilidade').attr('action', url);
