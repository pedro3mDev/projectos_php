...
<div>
    ...
    <table class="table dt-table">
        <thead>
            <th width="30%"><?php echo _l('impacto_quantitativo'); ?></th>
            <th width="30%"><?php echo _l('description'); ?></th>
            <th width="30%"><?php echo _l('Valor'); ?></th>
            <th><?php echo _l('options'); ?></th>
        </thead>
        <tbody>
            <?php foreach($impacto_quantitativo as $c){ ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="javascript:;" data-id="<?= $c['id'] ?>" data-nome="<?= html_entity_decode($c['nome']) ?>"
                        data-descricao="<?= html_entity_decode($c['descricao']) ?>"
                        data-valor="<?= html_entity_decode($c['valor']) ?>"
                        class="btn btn-default btn-icon btn_edit_impacto_quantitativo">
                        <i class="fa fa-edit"></i>
                    </a>
                    <?php } ?>

                    <?php if(is_admin() || has_permission('psl_configuracoes','','delete')){ ?>
                    <a onclick="return confirm('Tens certteza que desejas eliminar esta Impacto Quantitativo?');"
                        href="<?php echo admin_url('gestao_formacao/delete_impacto_quantitativo/'.$c['id']); ?>"
    ...
    <div class="modal" id="modal_add" tabindex="-1" role="dialog">
        <div class="modal-dialog w-25">
            <?= form_open(admin_url('gestao_formacao/add_impacto_quantitativo'), array('method' => 'post')) ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form">
                                <div class="col-md-12">
                                    <?php echo render_input('nome','Impacto Qualitativo'); ?>
                                </div>
                                <div class="col-md-12">
    ...
    <?= form_open(admin_url('gestao_formacao/editar_impacto_quantitativo'), array('method' => 'post', 'id' => 'form_edit_impacto_quantitativo')) ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form">
                                <div class="col-md-12">
                                    <?php echo render_input('e_nome','impacto_quantitativo'); ?>
                                </div>
                                <div class="col-md-12">
                                    <?php echo render_input('e_valor','Valor', '', 'number'); ?>
                                </div>
                                <div class="col-md-12">
