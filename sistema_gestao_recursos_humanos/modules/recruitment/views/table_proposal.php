...
$result = data_tables_init($aColumns, $sIndexColumn, $sTable, $join, $where, ['id', 'cp_motivo', 'cp_tipo_sanguineo', 'direcao_id','seccao_id','position_name', db_prefix().'departments.name as dpm_name','workplace','salary_from','salary_to','from_date','to_date','ages_to','ages_from','height','weight','job_description','reason_recruitment','approver','gender','experience','literacy']);
