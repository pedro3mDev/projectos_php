                        ...
                        <p class="bold margin-top-15 general-infor-color"><?php echo _l('list_of_evaluation_criteria'); ?></p>
              			...
              			<div id="list_criteria">
	                          ...
	                          <div class="row">
	                            ...
	                            <div class="col-md-12 new-kpi-al pull-right padding-left-right-20-0">
	                            	<div id ="new_kpi" class="row paddig-top-height-0-75" >
										...
										<div class="col-md-3 padding-right-0">
	                                  		<label for="percent[0][0]" class="control-label"><span class="text-danger">* </span><?php echo _l('Percentagem') ?></label>
	                                	...
	                                	<div class="col-md-2" name="button_add_kpi lightheitgh-84-nowrap">
