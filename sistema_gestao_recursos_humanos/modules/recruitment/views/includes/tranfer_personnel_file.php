...
<div class="modal _project_file" tabindex="-1" role="dialog" data-toggle="modal" >
   <div class="modal-dialog full-screen-modal" role="document" style="width: 65%;">
      <div class="modal-content">
         ...
         <div class="modal-footer">
            <button type="button" class="btn btn-danger" onclick="close_modal_manually('._project_file'); return false;"><?php echo _l('cancel'); ?></button>
         </div>
      </div>
      <!-- /.modal-content -->
   </div>
