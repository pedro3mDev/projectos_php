...
<table class="table dt-table">
 <thead>
    ...
    <th><?php echo _l('Centro de Custo'); ?></th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                     ...
                     <div class="form">
                       ...
                       <div class="form-group">
                        <label for="job_skill[]" class="control-label"><?php echo _l('skill_name'); ?><span class="text-danger">*</span></label> 
                    ...
                    <div class="form-group">
                       <label  for="industry_id"><?php echo _l('Centro de Custo'); ?><span class="text-danger">*</span></label>
