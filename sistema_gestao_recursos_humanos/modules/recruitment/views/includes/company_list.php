...
<div class="_buttons">
    <a href="#" onclick="new_company(); return false;" class="btn btn-info pull-left display-block">
        <?php echo _l('Novo Centro de Custo'); ?>
    </a>
</div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    <span class="edit-title"><?php echo _l('Editar Centro de Custo'); ?></span>
                    <span class="add-title"><?php echo _l('Novo Centro de Custo'); ?></span>
                </h4>
            </div>
            <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                         <div id="additional_company"></div>
                            <?php echo render_input('company_name', 'Nome'); ?>
                        </div>

                        <div class="col-md-12">
                            <?php echo render_textarea('company_address', 'Endereço') ?>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <label><?php echo _l('Imagem') ?></label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal"><?php echo _l('cancel'); ?></button>
