...
?>
                    ...
                    <button type="button" class="btn btn-danger pull-right"
                        onclick="window.location.href='<?= admin_url('recruitment/candidate_profile'); ?>'">
                        &lt; Recuar
                    </button>
                    <a href="Javascript:void(0);" id="toggle_popup_approval"
                        class="btn btn-success display-block pull-right"><i
                            class="fa fa-user-md"></i><?php echo ' ' . _l('rec_care') . ' '; ?><i
                            class="fa fa-caret-down"></i></a>
                    <ul id="popup_approval" class="dropdown-menu dropdown-menu-right min-width-440">
                        <li>
                            <br>
                            <div class="col-md-12">
                                <a href="#" onclick="interview(); return false;"
                                    class="btn btn-info pull-right display-block mright5 interview-background"><i
                                        class="fa fa-microphone"></i><?php echo ' ' . _l('interview'); ?></a>
                                <a href="#" onclick="test(); return false;"
                                    class="btn btn-info pull-right display-block mright5 test-background"><i
                                        class="fa fa-forward"></i><?php echo ' ' . _l('test'); ?></a>
                                <a href="#" onclick="call(); return false;"
                                    class="btn btn-info pull-right display-block mright5 call-background"><i
                                        class="fa fa-phone"></i><?php echo ' ' . _l('call'); ?></a>
                                <a href="#" onclick="sendmail(); return false;"
                                    class="btn btn-info pull-right display-block mright5 send_mail-background"><i
                    ...
                    <a href="#" onclick="send_mail_candidate(); return false;"
                        class="btn btn-info pull-right display-block mright5"><i
                            class="fa fa-envelope"></i><?php echo ' ' . _l('send_mail'); ?></a>

                    <a href="#" class="btn btn-warning pull-right mright5" data-toggle="modal"
                        data-target="#candidate_rating"><i
                            class="fa fa-star"></i><?php echo ' ' . _l('rate_candidate'); ?></a>
                    <div class="col-md-3 pull-right">
                        <select name="change_status" id="change_status"
                            onchange="change_status_candidate(this,<?php echo html_entity_decode($candidate->id); ?>); return false;"
                            class="selectpicker" data-width="100%"
                            data-none-selected-text="<?php echo _l('change_status_to'); ?>">
                            <option value=""></option>
                            <option value="1" class="<?php if ($candidate->status == 1) {echo 'hide';}?>">
                                <?php echo _l('application'); ?></option>
                            <option value="2" class="<?php if ($candidate->status == 2) {echo 'hide';}?>">
                                <?php echo _l('potential'); ?></option>
                            <option value="3" class="<?php if ($candidate->status == 3) {echo 'hide';}?>">
                                <?php echo _l('interview'); ?></option>
                            <option value="4" class="<?php if ($candidate->status == 4) {echo 'hide';}?>">
                                <?php echo _l('won_interview'); ?></option>
                            <option value="5" class="<?php if ($candidate->status == 5) {echo 'hide';}?>">
                                <?php echo _l('send_offer'); ?></option>
                            <option value="6" class="<?php if ($candidate->status == 6) {echo 'hide';}?>">
                                <?php echo _l('elect'); ?></option>
                            <option value="7" class="<?php if ($candidate->status == 7) {echo 'hide';}?>">
                                <?php echo _l('non_elect'); ?></option>
                            <option value="8" class="<?php if ($candidate->status == 8) {echo 'hide';}?>">
                                <?php echo _l('unanswer'); ?></option>
                            <option value="9" class="<?php if ($candidate->status == 9) {echo 'hide';}?>">
                                <?php echo _l('transferred'); ?></option>
                            <option value="10" class="<?php if ($candidate->status == 10) {echo 'hide';}?>">
                            ...
                            <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                                <li role="presentation" class="active">
                                    <a href="#detail" aria-controls="detail" role="tab" data-toggle="tab"
                                        ...
                                        <span
                                            class="glyphicon glyphicon-align-justify"></span>&nbsp;<?php echo _l('detail'); ?>
                                    </a>
                                </li>
                                <li role="presentation">
                                    <a href="#history_recruitment" aria-controls="history_recruitment" role="tab"
                                        data-toggle="tab" aria-controls="history_recruitment">
                                        <i class="fa fa-calendar"></i>&nbsp;<?php echo _l('history_recruitment'); ?>
                                    </a>
                                </li>
                                <li role="presentation">
                                    <a href="#capacity_profile" aria-controls="capacity_profile" role="tab"
                                        data-toggle="tab" aria-controls="capacity_profile">
                                ...
                                <div class="container">
                                    <div class="picture-container pull-left">
                                        <div class="picture pull-left">
                                            <img class="width-height-160"
                                                src="<?php if (isset($candidate->avar)) {echo site_url(RECRUITMENT_PATH . 'candidate/avartar/' . $candidate->id . '/' . $candidate->avar->file_name);} else {echo site_url(RECRUITMENT_PATH . 'none_avatar.jpg');}?>"
                                ...
                                <table class="table border table-striped margin-top-0">
                                    <tbody>
                                        <tr class="project-overview">
                                            ...
                                            <td><?php echo html_entity_decode($candidate->candidate_name . ' ' . $candidate->last_name); ?>
                                            </td>
                                        </tr>
                                        <tr class="project-overview">
                                            <td class="bold"><?php echo _l('gender'); ?></td>
                                            <?php $candidate_gender = isset($candidate->gender)?$candidate->gender: '';  ?>
                                            <td><?php echo _l($candidate_gender); ?></td>
                                        </tr>
                                        <tr class="project-overview">
                                            <td class="bold"><?php echo _l('nation'); ?></td>
                                            <?php $candidate_nation = isset($candidate->nation)?$candidate->nation: '';  ?>
                                            <td><?php echo html_entity_decode($candidate_nation); ?></td>
                                        </tr>

                                        <tr class="project-overview">
                                            <td class="bold"><?php echo _l('marital_status'); ?></td>
                                            <?php $candidate_marital_status = isset($candidate->marital_status)?$candidate->marital_status: '';  ?>
                                            <td><?php echo _l($candidate_marital_status); ?></td>
                                        </tr>
                                        <tr class="project-overview">
                                            <td class="bold"><?php echo _l('height'); ?></td>
                                            <?php $candidate_height = isset($candidate->height)?$candidate->height: '';  ?>
                                            <td><?php echo html_entity_decode( $candidate_height); ?></td>
                                        </tr>
                                ...
                                <table class="table border table-striped margin-top-0">
                                    <tbody>
                                        ...
                                        <tr class="project-overview">
                                            ...
                                            <?php $candidate_birthday = isset($candidate->birthday)?$candidate->birthday: '';  ?>
                                            <td><?php echo _d($candidate_birthday); ?></td>
                                        </tr>
                                        <tr class="project-overview">
                                            <td class="bold"><?php echo _l('nationality'); ?></td>
                                            <?php $candidate_nationality = isset($candidate->nationality)?$candidate->nationality: '';  ?>
                                            <td><?php echo html_entity_decode($candidate_nationality); ?></td>
                                        </tr>
                                        <tr class="project-overview">
                                            <td class="bold"><?php echo _l('religion'); ?></td>
                                            <?php $candidate_religion = isset($candidate->religion)?$candidate->religion: '';  ?>
                                            <td><?php echo html_entity_decode($candidate_religion); ?></td>
                                        </tr>
                                        <tr class="project-overview">
                                            <td class="bold"><?php echo _l('weight'); ?></td>
                                            <?php $candidate_weight = isset($candidate->weight)?$candidate->weight: '';  ?>
                                            <td><?php echo html_entity_decode($candidate_weight); ?></td>
                                        </tr>
...
?>
                                        ...
                                        <tr class="project-overview">
                                            ...
                                            <td><?php echo $candidate->identification; ?></td>
                                        </tr>
                                        ...
                                        <tr class="project-overview">
                                            ...
                                            <td><?php echo $candidate->resident; ?></td>
                                        </tr>
                                        <tr class="project-overview">
                                        ...
                                        <tr class="project-overview">
                                            ...
                                            <td><?php echo $candidate->alternate_contact_number; ?></td>
                                        </tr>

                                        <tr class="project-overview">
                                            <td class="bold"><?php echo _l('skype'); ?></td>
                                            <td><a
                                                    href="<?php echo $candidate->skype; ?>"><?php echo $candidate->skype; ?></a>
                                            </td>
                                        </tr>
                                        <tr class="project-overview">
                                        ...
                                        <tr class="project-overview">
                                            ...
                                            <td><?php echo $candidate->introduce_yourself; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                ...
                                <table class="table border table-striped margin-top-0">
                                    <tbody>
                                        ...
                                        <tr class="project-overview">
                                            ...
                                            <td><?php echo app_format_money($candidate->desired_salary, $current_id); ?>
                                            </td>
                                        </tr>
                                        <tr class="project-overview">
                                        ...
                                        <tr class="project-overview">
                                            ...
                                            <td><?php echo $candidate->current_accommodation; ?></td>
                                        </tr>
                                        <tr class="project-overview">
                                            <td class="bold"><?php echo _l('email'); ?></td>
                                            <td><a
                                                    href="mailto:<?php echo $candidate->email; ?>"><?php echo $candidate->email; ?></a>
                                            </td>
                                        ...
                                        <tr class="project-overview">
                                            ...
                                            <td><a
                                                    href="<?php echo $candidate->facebook; ?>"><?php echo $candidate->facebook; ?></a>
                                            </td>
                                        </tr>
                                        <tr class="project-overview">
                                            <td class="bold"><?php echo _l('linkedin'); ?></td>
                                            <td><a
                                                    href="<?php echo $candidate->linkedin; ?>"><?php echo $candidate->linkedin; ?></a>
                                            </td>
                                        </tr>

                                        <tr class="project-overview">
                                            <td class="bold"><?php echo _l('interests'); ?></td>
                                            <td><?php echo $candidate->interests; ?></td>
                                        </tr>
                                ...
                                <table class="table dt-table margin-top-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="project-overview">
                                            ...
                                            <td><?php echo html_entity_decode(app_format_money($we['salary'], $current_id)); ?>
                                            </td>
...
$_data = '<a href="' . admin_url('staff/profile/' . $li['added_from']) . '">' . staff_profile_image($li['added_from'], [
	...
	?>
                                        ...
                                        <td><?php echo html_entity_decode($li['from_time'] . ' - ' . $li['to_time']); ?>
                                        </td>
		...
		?>
                                        <tr>
                                            <td class="bold text-danger">
                                                <?php echo html_entity_decode($count_gr . '. ' . get_criteria_name($key)); ?>
                                            </td>
                                            <td class="bold text-danger">
                                                <?php echo html_entity_decode($gr['toltal_percent'] . '%'); ?></td>
                                            <td class="bold text-danger"></td>
                                            <td class="bold text-danger">
                                                <?php echo html_entity_decode($gr['result']); ?></td>
                                        </tr>
                                        <?php $count_cr = 1;foreach ($cd_evaluation as $cd) {
			if ($cd['group_criteria'] == $key) {
				?>
                                        <tr>
                                            <td><?php echo html_entity_decode($count_gr . '.' . $count_cr . '. ' . get_criteria_name($cd['criteria'])); ?>
                                            </td>
...
$sp1 = '';
				...
				?>
                                            ...
                                            <td><?php echo html_entity_decode(($cd['rate_score'] * $cd['percent']) / 100); ?>
                                            </td>
                                        </tr>
                                        <?php $count_cr++;}}?>
                                        <?php $count_gr++;}}?>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content width-100">
            <div class="modal-header">
                <button d type="button" class="close" data-dismiss="modal" aria-label="Close"><span
...
?>
            ...
            <div class="modal-footer">
                ...
                <button id="sm_btn" type="submit" onclick="submit_care_candidate(); return false;"
...
<div class="modal fade" id="candidate_rating" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	...
	foreach ($evaluation['groups'] as $gr) {
		...
		?>
                        ...
                        <h5 class="bold"><?php echo html_entity_decode($count_gr . '. ' . $gr['criteria_title']); ?>
                        </h5>
...
$count_cr = 1;
				...
				?>
                        ...
                        <div class="star-rating">
                            ...
                            <div class="pull-right font-size-125">
                                <span class="fa fa-star-o margin-top-8" data-rating="1"
                                    data-id="<?php echo html_entity_decode($cr['evaluation_criteria']); ?>"></span>
                                <span class="fa fa-star-o margin-top-8" data-rating="2"
                                    data-id="<?php echo html_entity_decode($cr['evaluation_criteria']); ?>"></span>
                                <span class="fa fa-star-o margin-top-8" data-rating="3"
                                    data-id="<?php echo html_entity_decode($cr['evaluation_criteria']); ?>"></span>
                                <span class="fa fa-star-o margin-top-8" data-rating="4"
                                    data-id="<?php echo html_entity_decode($cr['evaluation_criteria']); ?>"></span>
                                <span class="fa fa-star-o margin-top-8" data-rating="5"
                                    data-id="<?php echo html_entity_decode($cr['evaluation_criteria']); ?>"></span>
                                <input type="hidden"
                                    name="rating[<?php echo html_entity_decode($cr['evaluation_criteria']); ?>]"
                                    class="rating-value" value="">
                                <input type="hidden"
                                    name="percent[<?php echo html_entity_decode($cr['evaluation_criteria']); ?>]"
                                    value="<?php echo html_entity_decode($cr['percent']); ?>">
                                <input type="hidden"
                                    name="group[<?php echo html_entity_decode($cr['evaluation_criteria']); ?>]"
                                    value="<?php echo html_entity_decode($gr['id']); ?>">
                            </div>
		...
		$count_gr++;}?>
            ...
            <div class="modal-footer">
                ...
                <button group="submit" onclick="submit_rating_candidate(); return false;"
                    class="btn btn-info"><?php echo _l('submit'); ?></button>
                <?php echo form_close(); ?>
            </div>
