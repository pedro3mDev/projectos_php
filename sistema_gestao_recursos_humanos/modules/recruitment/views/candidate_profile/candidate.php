   ...
   <div class="content">
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          Recrutamento e Selecção / Candidaturas / Novo Candidato
          </a>
        </div>
...
echo render_textarea('current_accommodation', 'current_accommodation', $current_accommodation)?>
                  ...
                  <div class="col-md-12">
                  <p class="bold margin-top-15 general-infor-color"><?php echo _l('work_experience') ?></p>
                  <hr class="margin-top-10 general-infor-hr"/>
	...
	foreach ($candidate->work_experience as $key => $val) {
		...
		echo render_textarea('job_description[' . $key . ']', 'job_description', $job_description)?>
                  ...
                  <p class="bold margin-top-15 general-infor-color"><?php echo _l('literacy'); ?></p>
                  <hr class="margin-top-10 general-infor-hr"/>
	...
	foreach ($candidate->literacy as $key => $val) {
		...
		echo render_input('training_form[' . $key . ']', 'training_form', $training_form)?>
                  ...
                  <div class="col-md-12">
                  <p class="bold margin-top-15 general-infor-color"><?php echo _l('family_infor') ?></p>
                  <hr class="margin-top-10 general-infor-hr"/>
