      ...
      <div class="row">
        <div class="col-md-6">
          <a class="dashboard-link" href="" style="font-size: 16px; color: #333;">
            Recrutamento e Selecção / Candidaturas
          </a>
        </div>
            ...
            <a class="text-warning text-center mbot15">
              ...
              <div class="d-flex align-items-center justify-content-center">
                <p style="font-size:16px; color:#DAA520;"> 
                  ...
                  <?= number_format($total_candidaturas, 0, ' ', '.') ?>
                </p>
              </div>
            </a>
          </div>
          ...
          <div class="top_stats_wrapper minheight85 d-flex align-items-center justify-content-center flex-column" style="border-bottom: 1px solid #336; border-left: 4px solid #8B0000; ">
            <a class="text-warning text-center mbot15">
              ...
              <div class="d-flex align-items-center justify-content-center">
                <p style="font-size:16px; color:#DAA520;"> 
                  <i class="fas fa-users"></i>
                  <?= number_format($total_candidaturas_1, 0, ' ', '.') ?>
                </p>
              </div>
            </a>
          </div>
            ...
            <a class="text-warning text-center mbot15">
              ...
              <div class="d-flex align-items-center justify-content-center">
                <p style="font-size:16px; color:#DAA520;"> 
                  ...
                  <?= number_format($total_candidaturas_3, 0, ' ', '.') ?>
                </p>
              </div>
            </a>
          </div>
            ...
            <a class="text-warning text-center mbot15">
              ...
              <div class="d-flex align-items-center justify-content-center">
                <p style="font-size:16px; color:#DAA520;"> 
                  ...
                  <?= number_format($total_candidaturas_4, 0, ' ', '.') ?>
                </p>
              </div>
            </a>
          </div>
         ...
         <div class="col-md-12" id="small-table">
            <div class="panel_s">
               <div class="panel-body">
                  <div class="row">
                     <div class="col-md-12">
                      <h4 class="no-margin font-bold"><i class="fa fa-user-o" aria-hidden="true"></i>Candidaturas <!--?php echo _l($title); ?--></h4>
                      <hr />
                    </div>
                  </div>
                  <div class="row">
      ...
      <div class="modal-content width-100">
          ...
          <div class="modal-body">
              <div class="row">
                ...
                <div class="col-md-12">
                  <?php echo render_input('subject', 'Assunto do Email'); ?>
                </div>

                <div class="col-md-12">
                  <?php echo render_textarea('content', 'Conteúdo', '', array(), array(), '', 'tinymce') ?>
                </div>
                <div id="type_care">
          ...
          <div class="modal-footer">
              ...
              <button id="sm_btn" type="submit" class="btn btn-info">Enviar</button>
