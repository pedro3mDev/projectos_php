            ...
            <div class="row">
         	...
         	<div class="row">
		         <div class="form-group col-md-6">
		            ...
		            <input type="text" class="form-control" name="facebook" value="<?php echo $candidate->facebook; ?>">
		         </div>
		         
		         <div class="form-group col-md-6">
		            <label for="skype" class="control-label"><i class="fa fa-skype"></i> <?php echo _l('staff_add_edit_skype'); ?></label>
		            <input type="text" class="form-control" name="skype" value="<?php echo $candidate->skype; ?>">
		         </div>
         	</div>
         	<div class="row">
		         <div class="col-md-4">
