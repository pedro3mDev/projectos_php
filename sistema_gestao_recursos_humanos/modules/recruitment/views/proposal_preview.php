<div class="panel_s">
    <div class="panel-body">
        ...
        <div class="row col-md-12">
            ...
            <div id="reject_div">
                <a href="<?php echo admin_url('recruitment/approve_reject_proposal/'.'reject'.'/'.$proposals->id); ?>"
                    id="reject_btn" data-loading-text="<?php echo _l('wait_text'); ?>"
                    class="btn btn-warning pull-right mleft10 display-block">
                    <?php echo _l('reject'); ?>
                </a>
            </div>
            <div id="approved_div">
                <a href="<?php echo admin_url('recruitment/approve_reject_proposal/'.'approved'.'/'.$proposals->id); ?>"
                    id="approved_btn" data-loading-text="<?php echo _l('wait_text'); ?>"
            ...
            <table class="table border table-striped margin-top-0">
                <tbody>
                    ...
                    <tr class="project-overview">
                        ...
                        <td><?php echo get_rec_direcao_name($proposals->direcao_id); ?></td>
                    </tr>
                    <tr class="project-overview">
                    ...
                    <tr class="project-overview">
                        ...
                        <td><?php echo get_rec_seccao_name($proposals->seccao_id); ?></td>
                    </tr>
                    <tr class="project-overview">
                 ...
                 ?>
                        ...
                        <td><?php echo app_format_money($proposals->salary_from, $current_id).' - '.app_format_money($proposals->salary_to, $current_id); ?>
                        </td>
                    </tr>
                    <tr class="project-overview">
                    ...
                    <tr class="project-overview">
                        ...
                        <td><?php echo html_entity_decode(get_rec_motivo_name($proposals->cp_motivo)); ?></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table table-striped margin-top-0">
                <tbody>
                    ...
                    <tr class="project-overview">
                        ...
                        <td><a
                                href="<?php echo admin_url('staff/profile/'.$proposals->add_from); ?>"><?php echo get_staff_full_name($proposals->add_from); ?></a>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table table-striped margin-top-0">
                <tbody>
                    ...
                    <tr class="project-overview">
                        ...
                        <td><?php echo html_entity_decode(get_tipo_sanguineo_name($proposals->cp_tipo_sanguineo)); ?>
                        </td>
                    </tr>
                    <!-- <tr class="project-overview">
