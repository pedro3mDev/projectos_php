        ...
        <div class="row">
            <div class="col-md-6">
                <a class="dashboard-link" href="" style="font-size: 16px; color: #333;">
                    Recrutamento e Selecção / Campanhas
                </a>
            </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-3  ">
                                ...
                                <a href="#" onclick="new_campaign(); return false;"
                                    class="btn btn-info pull-left display-block btn_new_campanha">
                        ...
                        <div class="row">
                            ...
                            <div class=" col-md-3">
                                <select name="department_filter[]" id="department_filter" class="selectpicker"
                                    multiple="true" data-live-search="true" data-width="100%"
                                    data-none-selected-text="<?php echo _l('filter_by_department'); ?>">

                                    <?php foreach ($departments as $s) {?>
                                    <option value="<?php echo html_entity_decode($s['departmentid']); ?>">
                                        <?php echo html_entity_decode($s['name']); ?></option>
                                    <?php }?>
                                </select>
                            </div>
                            <div class=" col-md-3">
                                <select name="position_filter[]" id="position_filter" class="selectpicker"
                                    data-live-search="true" multiple="true" data-width="100%"
                                    data-none-selected-text="<?php echo _l('filter_by_position'); ?>">

                                    <?php foreach ($positions as $s) {?>
                                    <option value="<?php echo html_entity_decode($s['position_id']); ?>">
                                        <?php echo html_entity_decode($s['position_name']); ?></option>
                                    <?php }?>
                                </select>
                            </div>
                            <div class=" col-md-2">
                                <div class="form">
                                    <select name="status_filter[]" id="status_filter" class="selectpicker"
                                        data-live-search="true" multiple="true" data-width="100%"
                            ...
                            <div class="col-md-1 pull-right">
                                <a href="#"
                                    ...
                                    onclick="toggle_small_view_campaign('.campaign_sm','#campaign_sm_view'); return false;"
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content width-125">
            ...
            <div class="modal-body">
                        ...
                        <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                            <li role="presentation" class="active">
                                <a href="#general_infor" aria-controls="general_infor" role="tab" data-toggle="tab"
                                    aria-controls="general_infor">
                                    <span
                                        class="glyphicon glyphicon-align-justify"></span>&nbsp;<?php echo _l('general_infor'); ?>
                                </a>
                            </li>
                            <li role="presentation">
                                <a href="#candidate_request" aria-controls="candidate_request" role="tab"
                                    data-toggle="tab" aria-controls="candidate_request">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="general_infor">
                        ...
                        <div
                            class="col-md-12 <?php  if(get_recruitment_option('recruitment_create_campaign_with_plan') == 1 ){ echo 'hide';} ;?>">
                            <label for="cp_proposal"><?php echo _l('recruitment_proposal'); ?></label>
                            <select name="cp_proposal[]" id="proposal" class="selectpicker" multiple="true"
                                ...
                                <option value="<?php echo html_entity_decode($s['id']); ?>">
                                    <?php echo html_entity_decode($s['proposal_name']); ?></option>
                                <?php }?>
                            </select>
                            <br><br>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="rec_channel_form_id" id="rec_channel_form_id" class="selectpicker"
                                    data-live-search="true" data-width="100%"
                                    data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
                                    <option value=""></option>
                                    <?php foreach ($rec_channel_form as $rec_c_f) {?>
                                    <option value="<?php echo html_entity_decode($rec_c_f['id']); ?>">
                                        <?php echo html_entity_decode($rec_c_f['r_form_name']); ?></option>
                                    <?php }?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label for="position"><small class="req text-danger">* </small>
                                <?php echo _l('position'); ?></label>
                            <select name="cp_position" id="position" class="selectpicker" data-live-search="true"
                                data-width="100%"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="company_id"><?php echo _l('Centro de Custo'); ?></label>
                                <select name="company_id" id="company_id" class="selectpicker" data-live-search="true"
                                    data-width="100%"
                                    data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
                                    <option value=''></option>
                                    <?php foreach ($company_list as $company) {?>
                                    <option value="<?php echo html_entity_decode($company['id']); ?>">
                                        <?php echo html_entity_decode($company['company_name']); ?></option>
                                    <?php }?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="cp_form_work" id="form_of_work" class="selectpicker" data-width="100%"
                                    data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
                                    <option value=""></option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="cp_department" id="department" class="form-control">
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control text-right" name="cp_salary_from" value=""
                                    data-type="currency">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control text-right" name="cp_salary_to" value=""
                                    data-type="currency">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="checkbox checkbox-primary">
                                    <input type="checkbox" id="display_salary" name="display_salary"
                                        value="display_salary">

                                    <label for="display_salary"><?php echo _l('rec_display_salary'); ?><small><?php echo _l('rec_display_salary_tooltip') ?>
                                        </small>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6"> <?php echo render_date_input('cp_from_date', 'Data Inicial', ''); ?>
                        </div>
                        <div class="col-md-6"> <?php echo render_date_input('cp_to_date', 'Data Final', ''); ?></div>

                        <!-- <div class="col-md-12">
                            <?php echo render_textarea('cp_reason_recruitment', 'reason_recruitment', '') ?></div> -->
                        <div class="col-md-12">
                            <?php echo render_textarea('cp_job_description', 'job_description', '', array(), array(), '', 'tinymce') ?>
                        </div>
                        <div class="col-md-12">
                            <label for="motivo"><?php echo _l('motivo'); ?></label>
                            <select name="cp_motivo" id="motivo" class="selectpicker" data-width="100%">
                                <?php foreach($motivo as $item_mt) : ?>
                                <option value="<?= $item_mt['id']; ?>"><?= $item_mt['motivo']; ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label for="cp_manager"><small class="req text-danger">* </small>
                                <?php echo _l('manager'); ?></label>
                            <select name="cp_manager[]" id="manager" class="selectpicker" multiple="true"
                        ...
                        <div class="col-md-6">
                            <label for="cp_follower"><small class="req text-danger">* </small>
                                <?php echo _l('follower'); ?></label>
                            <select name="cp_follower[]" id="follower" class="selectpicker" multiple="true"
                                data-actions-box="true" data-live-search="true" data-width="100%"
                                data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" required>
                    ...
                    <div role="tabpanel" class="tab-pane" id="candidate_request">
                        ...
                        <div class="col-md-6"> <?php echo render_input('cp_ages_from', 'ages_from', '', 'number'); ?>
                        </div>
                        <div class="col-md-6"> <?php echo render_input('cp_ages_to', 'ages_to', '', 'number'); ?></div>

                        <div class="col-md-6">
                            <label for="cp_gender"><?php echo _l('gender'); ?></label>
                            <select name="cp_gender" id="gender" class="selectpicker" data-width="100%"
                                data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
                                <option value=""></option>
                        ...
                        <div class="col-md-6">
                            <label for="tipo_sanguineo"><?php echo _l('tipo_sanguineo'); ?></label>
                            <select name="cp_tipo_sanguineo" id="tipo_sanguineo" class="selectpicker" data-width="100%"
                                data-none-selected-text="<?php echo _l('not_required'); ?>">
                                <option value=""></option>
                                <?php foreach($tipo_sanguineo as $item_ts) : ?>
                                <option value="<?= $item_ts['id']; ?>"><?= $item_ts['tipo_sanguineo']; ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                        <!-- <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" id="height" name="cp_height" class="form-control text-aligh-right"
                        ...
                        <!-- <div class="col-md-4">
                            ...
                            ?>
                                ...
                                <input type="weight" id="weight" name="cp_weight" class="form-control text-aligh-right"
                                    value="">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="cp_literacy" id="literacy" class="selectpicker" data-width="100%"
                                data-none-selected-text="<?php echo _l('not_required'); ?>">
                                <option value=""></option>
                                ...
                                <option value="intermediate_vocational"><?php echo _l('intermediate_vocational'); ?>
                                </option>
                                ...
                                <option value="intermediate_level_pro"><?php echo _l('intermediate_level_pro'); ?>
                                </option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label for="experience"><?php echo _l('experience'); ?></label>
                            <select name="cp_experience" id="experience" class="selectpicker" data-width="100%"
                                data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
                                <option value=""></option>
            ...
            <div class="modal-footer border-top-0">
                <button type="" class="btn btn-danger" data-dismiss="modal"><?php echo _l('cancel'); ?></button>
...
$(document).on('click', '.editt_campanha', function() {
    let direcao = $(this).attr('data-direcao');
    let departament = $(this).attr('data-department');
    let seccao = $(this).attr('data-seccao');

    let cp_motivo = $(this).attr('data-cp_motivo');
    let cp_tipo_sanguineo = $(this).attr('data-cp_tipo_sanguineo');

    $('select[name="cp_motivo"]').selectpicker('val', cp_motivo);
    $('select[name="cp_tipo_sanguineo"]').selectpicker('val', cp_tipo_sanguineo);

    $('#direcao').val(direcao);
    departamento(direcao, departament, seccao);
})

$(document).on('click', '.btn_new_campanha', function() {
    $('select[name="cp_motivo"]').selectpicker('val', 1);
    $('select[name="cp_tipo_sanguineo"]').selectpicker('val', '');
    $('#direcao').val('');
    $('#department').val('');
    $('#seccao').val('');
})
