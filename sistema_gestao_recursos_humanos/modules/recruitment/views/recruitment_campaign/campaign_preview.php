<div class="panel_s">
    <div class="panel-body">
        ...
        <div class=" col-md-3 pull-right">
            <select name="change_status" id="change_status" class="selectpicker dropdown bootstrap-select show-tick bs3"
                onchange="change_status_campaign(this,<?php echo html_entity_decode($campaigns->cp_id); ?>); return false;"
                data-live-search="true" data-width="100%"
                data-none-selected-text="<?php echo _l('change_status_to'); ?>">

                <option value="1" <?php if ($campaigns->cp_status == 1) {echo 'selected';}?>>
                    <?php echo _l('planning'); ?></option>
                <option value="3" <?php if ($campaigns->cp_status == 3) {echo 'selected';}?>>
                    <?php echo _l('in_progress'); ?></option>
                <option value="4" <?php if ($campaigns->cp_status == 4) {echo 'selected';}?>><?php echo _l('finish'); ?>
                </option>
                <option value="5" <?php if ($campaigns->cp_status == 5) {echo 'selected';}?>><?php echo _l('cancel'); ?>
                </option>
                ...
                <table class="table border table-striped margin-top-0">
                    <tbody>
                        ...
                        <tr class="project-overview">
                            ...
                            <td><?php echo get_rec_direcao_name($campaigns->direcao_id); ?></td>
                        </tr>
                        <tr class="project-overview">
                        ...
                        <tr class="project-overview">
                            ...
                            <td><?php echo get_rec_seccao_name($campaigns->seccao_id); ?></td>
                        </tr>
                        <tr class="project-overview">
                        ...
                        <tr class="project-overview">
                            ...
                            <td><?php echo app_format_money($campaigns->cp_salary_from, $current_id) . ' - ' . app_format_money($campaigns->cp_salary_to, $current_id); ?>
                            </td>
                        </tr>
                        <tr class="project-overview">
                  ...
                  $r_form_name='';
                   ...
                   ?>
                        ...
                        <tr class="project-overview">
                            ...
                            <td><?php echo html_entity_decode(get_rec_motivo_name($campaigns->cp_motivo)); ?></td>
                        </tr>
                        <tr class="project-overview">
                        ...
                        <tr class="project-overview">
                            ...
                            <td>
                                <span class="label label-default">
                                    <a href="<?php echo site_url('recruitment/forms/wtl/'.$campaigns->cp_id.'/'.$rec_channel); ?>"
                                        target="_blank"><?php echo site_url('recruitment/forms/wtl/'.$campaigns->cp_id.'/'.$rec_channel); ?></a>
                                </span>
                            </td>
                        </tr>
                        <?php } ?>
...
?>
                        ...
                        <tr class="project-overview">
                            ...
                            <td><a
                                    href="<?php echo admin_url('staff/profile/' . $campaigns->cp_add_from); ?>"><?php echo get_staff_full_name($campaigns->cp_add_from); ?></a>
                            </td>
                        </tr>
                        <tr class="project-overview">
  ...
  ?>
    ...
    'data-title' => get_staff_full_name($f),
            ...
            <div class="col-md-12 padding-left-10">
                <p class="bold text-muted"><?php echo _l('job_description') . ': ' . $campaigns->cp_job_description; ?>
                </p>
                ...
                <table class="table table-striped margin-top-0">
                    <tbody>
                        <tr class="project-overview">
                            ...
                            <td><?php echo html_entity_decode($campaigns->cp_ages_from . ' - ' . $campaigns->cp_ages_to); ?>
                            </td>
                        </tr>
                        <tr class="project-overview">
                            <td class="bold"><?php echo _l('tipo_sanguineo'); ?></td>
                            <td><?php echo html_entity_decode(get_tipo_sanguineo_name($campaigns->cp_tipo_sanguineo)); ?>
                            </td>
                        </tr>
                        <tr class="project-overview">
