...
<body class="login_admin">
    <div class="row">
        <div class="col-md-6">
            <a class="dashboard-link" href="" style="font-size: 16px; color: #333;">
                Portal de Recrutamento / Visualizar Vaga
            </a>
        </div>
    ...
    <div class="panel_s" style="background-color: rgba(255, 255, 255, 0.8); ; border-radius: 5px;">
        <div class="panel-body">
			...
			?>
                <div class="col-md-12">
                    <div class="panel_s" style=" height: 200px; overflow-y: auto;">
                        <div class="panel-body">
                            <h4 class="no-margin font-bold">
                                <i class="fa fa-address-card-o" aria-hidden="true"></i>
                                <?php echo html_entity_decode($rec_campaingn->campaign_name) ?>
                            </h4>
                            <hr />
                            <div>
                                <table class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th id="titulo1" class="text-center">Duração</th>
                                            <th id="titulo1" class="text-center">Salário</th>
                                            <th class="titulo2" class="text-center">Cargo</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td class="text-center">
                                                <p
                                                    class="card-title bold  duration-title <?php if(strtotime(date("Y-m-d")) > strtotime($rec_campaingn->cp_to_date)){echo 'text-success' ;}else{ echo 'text-muted' ;} ?> ">
                                                    <?php echo html_entity_decode($rec_campaingn->cp_from_date.' - '.$rec_campaingn->cp_to_date); ?>
                                                </p>
                                            </td>
                                            <td class="text-center">
                                                <?php if($rec_campaingn->display_salary == 1){ ?>
                                                <h5 class="card-title bold text-muted ">
                                                    <?php echo _l('monthly_salary') ?> <span
                                                        class="bold"><?php echo html_entity_decode(app_format_money($rec_campaingn->cp_salary_from, $current_id).' - '.app_format_money($rec_campaingn->cp_salary_to, $current_id)) ?></span>
                                                </h5>
                                                <?php } ?>
                                            </td>
                                            <td class="text-center">
                                                <h5 class="card-title bold text-muted ">
                                                    <?php echo _l('job_position') ?>: <span
                                                        class="label label-success"><?php echo html_entity_decode($rec_campaingn->position_name) ?></span>
                                                </h5>
                                            </td>
                                        </tr>
                                    </tbody>
                ...
                <div class="col-md-12">
                    <div class="panel_s" style=" height: 200px; overflow-y: auto;">
                        <div class="panel-body">
                            <h4 class="no-margin font-bold">
                                <?php echo _l('Descrição do Trabalho') ?></h3>
                            </h4>
                            <hr />
                            <div>
                                <table class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th id="titulo1" class="text-center">Descrição</th>
                                            <th class="titulo2" class="text-center">Habilidade</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td class="text-center">
                                                <p class="card-text">
                                                    <?php echo html_entity_decode($rec_campaingn->cp_job_description) ?>.
                                                </p>
                                            </td>
                                            <td class="text-center">
                                                ...
                                                <button type="button"
                                                    class="btn btn-primary skill-margin"><?php echo html_entity_decode($value['skill_name']) ?></button>
                        ...
                        <div class="panel-body">
                            ...
                            <div>
                                <table class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th id="titulo1" class="text-center"><?php echo _l('location_') ?></th>
                                            <th id="titulo1" class="text-center">Centro Custo</th>
                                            <th id="titulo1" class="text-center"><?php echo _l('type_') ?></th>
                                            <th id="titulo1" class="text-center"><?php echo _l('degree') ?></th>
                                            <th id="titulo1" class="text-center"><?php echo _l('amount_recruiment') ?>
                                            </th>
                                            <th class="titulo2" class="text-center"><?php echo _l('experience') ?></th>
                                            <th class="titulo2" class="text-center"><?php echo _l('apply_before') ?>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
									...
									?>
                                                <?php echo html_entity_decode($cp_workplace) ?>
                                            </td>
                                            <td class="text-center">
                                                <?php 
										$company_name='' ;
									...
									?>
                                                <?php echo html_entity_decode($company_name) ?>
                                            </td>
                                            <td class="text-center">
                                                <?php 
										$cp_form_work='' ;
									...
									?>
                                                <?php echo html_entity_decode($cp_form_work) ?>
                                            </td>
                                            <td class="text-center">
                                                <?php 
										$cp_literacy='' ;
									...
									?>
                                                <?php echo html_entity_decode($cp_literacy) ?>
                                            </td>
                                            <td class="text-center">
                                                <?php 
									...
									?>
                                                <?php echo html_entity_decode($cp_amount_recruiment) ?>
                                            </td>
                                            <td class="text-center">
                                                <?php 
										$cp_experience='' ;
									...
									?>
                                                <?php echo html_entity_decode($cp_experience) ?>
                                            </td>
                                            <td class="text-center">
                                                <?php 
										$cp_to_date='' ;
									...
									?>
                                                <?php echo html_entity_decode($cp_to_date) ?>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <div class="card text-left buton-margin">
                                    <div class="card-body">
                                        <a class="btn btn-success"
                                            href="<?php echo site_url('recruitment/forms/wtl/'.$rec_campaingn->cp_id.'/'.$rec_channel->form_key); ?>"
                                            target="_blank"><i
                                                class="fa fa-paper-plane"></i><?php echo _l('apply_now') ?></a>
                                    </div>
                                </div>
                                <?php } ?>
                                <?php } ?>
                                <div class="card text-left buton-margin">
                                    <div class="card-body">
                                        <button type="button" class="btn btn-danger"
                                            onclick="send_mail_candidate(this,<?php echo $id; ?>); return false;"><i
                                                class="fa fa-envelope"></i><?php echo _l('email_to_friend') ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
					...
					?>
                        <div class="col-md-12">
                            <div class="form-group" app-field-wrapper="email">
                                <label for="email" class="control-label"> <small class="req text-danger">*
                                    </small><?php echo _l('send_to'); ?></label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group" app-field-wrapper="subject">
                                <label for="subject" class="control-label"> <small class="req text-danger">*
                                    </small><?php echo _l('subject'); ?></label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group" app-field-wrapper="content">
                                <label for="content" class="control-label"> <small class="req text-danger">*
                                    </small><?php echo _l('content'); ?></label>
...
<!-----
<div class="row"  style="background-color: rgba(255, 255, 255, 0.9) ; border-radius: 20px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.4);">
