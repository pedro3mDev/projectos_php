...
<div id="wrapper">
   ...
   <?php
      ...
      <?php  foreach ($rec_campaigns as $key => $value) {  break; ?>
        <a href="<?php echo admin_url('recruitment/triagem/'.$value['cp_id']) ?>">
          <div class="quick-stats-invoices col-md-3" style="cursor: pointer">
                <div class="top_stats_wrapper minheight85" >
                  <span class="text-warning mbot15">
                      <p class="text-uppercase mtop5 minheight35" style="font-size: 14px; font-weight: bold;">
                        <i class="hidden-sm glyphicon glyphicon-file"></i> 
                        <?php echo _l($value['campaign_name']); ?>
                      </p>
                      <span class="pull-right bold no-mtop fontsize24" style="font-size: 1.8rem">
                        <?php echo get_candidate_by_capmapign($value['cp_id']); ?>
                      </span>
                  </span>
            ...
            <div class="panel_s">
               <div class="panel-body">
                <?php echo form_hidden('interview_id', $interview_id); ?>
                  <div class="row">
                      <a href="<?php echo admin_url('recruitment/triagem_geral/') ?>"><button class="btn btn-primary " style="margin-left: 14px;"> Voltar</button></a>
                  </div>
                 
                    <?php echo $rec_campaigns_header; ?>
                    <br>
                    <!--Table-->
                    <?php echo  $candidates; ?>                       
                    <!--end Table-->
