...
<div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="javascript:;" data-id="<?= $c['departmentid'] ?>"
                        ...
                        data-responsavel="<?= html_entity_decode($c['gerente_id'] ?? '') ?>"
                    ...
                    <a onclick="return confirm('Tens certteza que desejas eliminar esta departamento?');"
                        href="<?php echo admin_url('configuracoes/delete_departamento/'.$c['departmentid']); ?>"
    ...
    <div class="modal" id="modal_add" tabindex="-1" role="dialog">
        <div class="modal-dialog w-25">
            <?= form_open(admin_url('configuracoes/add_departamento'), array('method' => 'post')) ?>
    ...
    <?= form_open(admin_url('configuracoes/editar_departamento'), array('method' => 'post', 'id' => 'form_edit_departamento')) ?>
