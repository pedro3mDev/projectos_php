...
<div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a onclick="return confirm('Tens certteza que desejas eliminar esta pelorio?');"
                        href="<?php echo admin_url('configuracoes/delete_pelorio/'.$c['id']); ?>"
    ...
    <div class="modal" id="modal_add" tabindex="-1" role="dialog">
        <div class="modal-dialog w-25">
            <?= form_open(admin_url('configuracoes/add_pelorio'), array('method' => 'post')) ?>
    ...
    <?= form_open(admin_url('configuracoes/editar_pelorio'), array('method' => 'post', 'id' => 'form_edit_pelorio')) ?>
