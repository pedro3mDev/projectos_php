...
<div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a onclick="return confirm('Tens certteza que desejas eliminar esta direcao?');"
                        href="<?php echo admin_url('configuracoes/delete_direcao/'.$c['id']); ?>"
    ...
    <div class="modal" id="modal_add" tabindex="-1" role="dialog">
        <div class="modal-dialog w-25">
            <?= form_open(admin_url('configuracoes/add_direcao'), array('method' => 'post')) ?>
    ...
    <?= form_open(admin_url('configuracoes/editar_direcao'), array('method' => 'post', 'id' => 'form_edit_direcao')) ?>
