...
<div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a onclick="return confirm('Tens certteza que desejas eliminar esta seccao?');"
                        href="<?php echo admin_url('configuracoes/delete_seccao/'.$c['id']); ?>"
    ...
    <div class="modal" id="modal_add" tabindex="-1" role="dialog">
        <div class="modal-dialog w-25">
            <?= form_open(admin_url('configuracoes/add_seccao'), array('method' => 'post')) ?>
    ...
    <?= form_open(admin_url('configuracoes/editar_seccao'), array('method' => 'post', 'id' => 'form_edit_seccao')) ?>
