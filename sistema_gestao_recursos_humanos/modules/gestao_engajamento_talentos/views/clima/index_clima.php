...
<div id="wrapper">
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-10">
                <a class="dashboard-link" href="" style="font-size: 16px; color: #333;">
                    Gestão de Engajamento de Talentos / Clima / Pesquisa de Clima
                </a>
            </div>
        ...
        <?php require 'modules/gestao_engajamento_talentos/views/clima/cards.php'; ?>
        </br>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo admin_url('gestao_engajamento_talentos/pesquisa_clima_aprovar/'.$item['id']); ?>"
                                            class="btn btn-success" style="color: white;">
                                            Aprovar
                                        </a>
                                        <a onclick="return confirm('Tens certteza que desejas rejeitar?');"
                                            href="<?php echo admin_url('gestao_engajamento_talentos/pesquisa_clima_rejeitar/'.$item['id']); ?>"
                                            class="btn btn-danger" style="color: white;">
                                            Rejeitar
                                        </a>
                                        <?php endif ?>
                                        <a href="<?php echo admin_url('gestao_engajamento_talentos/clima_visualizar_pesquisa/'.$item['id']) ?>"
                                        ...
                                        <a href="javascript:;" data-id="<?= $item['id'] ?>"
                                            ...
                                            class="btn btn-default btn-icon btn_edit_pesquisa_clima"
                                            style="background-color: #007bff; border-color: #007bff; color: white;">
                                            <i style="color:#fff;" class="fa fa-edit"></i>
                                        </a>
                                        <a onclick="return confirm('Tens certteza que desejas eliminar esta Pesquisa de Clima?');"
                                            href="<?php echo admin_url('gestao_engajamento_talentos/delete_pesquisa_clima/'.$item['id']) ?>"
...
<div class="modal" id="modal_add" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-md">
        <?php echo form_open(admin_url('gestao_engajamento_talentos/add_pesquisa_clima'), array('method' => 'post')); ?>
...
<?= form_open(admin_url('gestao_engajamento_talentos/editar_pesquisa_clima'), array('method' => 'post', 'id' => 'form_edit_pesquisa_clima')) ?>
...
<?php init_tail(); ?>
<script>
$('.btn_edit_pesquisa_clima').click(function() {
    ...
    let url = "<?= admin_url('gestao_engajamento_talentos/editar_pesquisa_clima') ?>/" + id;
    $('#form_edit_pesquisa_clima').attr('action', url);
