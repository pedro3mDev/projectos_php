...
<div id="wrapper">
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-10">
                <a class="dashboard-link" href="" style="font-size: 16px; color: #333;">
                    Gestão de Engajamento de Talentos / Comunidade / Grupo de Colaboração
                </a>
            </div>
        ...
        <?php require 'modules/gestao_engajamento_talentos/views/comunidade/cards.php'; ?>
        </br>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class=" col-md-12">
                                ...
                                <a href="<?php echo admin_url('gestao_engajamento_talentos/comunidade_evento')?>"
                        ...
                        <table class="table table-hover table-bordered table-responsive dt-table">
                            ...
                            <tbody>
                                <?php foreach($grupo_colaboracao as $item) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo admin_url('gestao_engajamento_talentos/comunidade_visualizar_grupo/'.$item['id'])?>"
                                        ...
                                        <a href="javascript:;" data-id="<?= html_entity_decode($item['id'] ?? '') ?>"
                                            ...
                                            class="btn btn-default btn-icon btn_edit_grupo_colaboracao"
                                            style="background-color: #007bff; border-color: #007bff; color: white;">
                                            <i style="color:#fff;" class="fa fa-edit"></i>
                                        </a>
                                        <a onclick="return confirm('Tens certteza que desejas eliminar este Grupo de Colaboração?');"
                                            href="<?php echo admin_url('gestao_engajamento_talentos/delete_grupo_colaboracao/'.$item['id'])?>"
...
<div class="modal" id="modal_add" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-md">
        <?php echo form_open(admin_url('gestao_engajamento_talentos/add_grupo_colaboracao'), array('method' => 'post')); ?>
...
<?= form_open_multipart(admin_url('gestao_engajamento_talentos/editar_grupo_colaboracao'), array('method' => 'post', 'id' => 'form_edit_grupo_colaboracao')) ?>
    ...
    <div class="modal-dialog w-25">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Editar Grupo de Colaboração</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
...
<?php init_tail(); ?>
<script>
$('.btn_edit_grupo_colaboracao').click(function() {
    let nome = $(this).attr('data-nome');
    let descricao = $(this).attr('data-descricao');
    let id = $(this).attr('data-id');

    let url = "<?= admin_url('gestao_engajamento_talentos/editar_grupo_colaboracao') ?>/" + id;
    $('#form_edit_grupo_colaboracao').attr('action', url);
