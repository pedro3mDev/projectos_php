...
<div>
	...
	<table class="table dt-table">
		<thead>
			<th width="30%"><?php echo _l('Pelorio Nome'); ?></th>
			<th><?php echo _l('Pelorio Email'); ?></th>
			<th><?php echo _l('Depende de'); ?></th>
		...
		<tbody>
			...
			foreach($tabela as $c){ ?>
				<tr>
					...
					<td> <span class="label label-tag "><?php echo $conselho[$c['conselho_id']]; ?></span></td>
					<td>
						...
						<?php if(is_admin() || has_permission('hrm_setting','','delete')){ ?>
							<a href="<?php echo admin_url('hr_profile/delete_pelorios/'.$c['id']); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
						<?php } ?>
	...
	<div class="modal" id="modal_add" tabindex="-1" role="dialog">
		<div class="modal-dialog w-25">
		    <form method="get" action="<?php echo admin_url('hr_profile/add_pelorios'); ?>">
    ...
    <form method="get" action="<?php echo admin_url('hr_profile/edit_pelorios'); ?>">
