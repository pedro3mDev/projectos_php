        ...
        <div class="row">
            <div class="col-md-6">
                <a class="dashboard-link" href="" style="font-size: 16px; color: #333;">
                    Gestão de Integração / Funcionários
                </a>
            </div>
                    ...
                    <div class="panel-body">
                        <div class="_buttons">
                            ...
                            <a href="<?php echo admin_url('hr_profile/new_member'); ?>"
                                class="btn mright5 btn-info pull-left display-block "><?php echo _l('Novo elemento'); ?></a>
                            <a href="<?php echo admin_url('hr_profile/importxlsx'); ?>"
                                class="btn mright5 btn-success pull-left  ">
                                <?php echo _l('Importar'); ?>
                            </a>
                            <?php } ?>

                            <?php if (is_admin() || has_permission('hrm_hr_records','','create') || has_permission('hrm_hr_records','','edit') ) { ?>
                            <a href="#" onclick="staff_export_item(); return false;"
                                class="mright5 btn btn-warning pull-left   hr_export_staff">
                                <?php echo _l('Exportar'); ?>
                            </a>
                            <a href="#" id="dowload_items"
                                class="btn btn-success pull-left  mr-4 button-margin-r-b hide"><?php echo _l('dowload_staffs'); ?></a>
                            <?php } ?>

                            <a href="#" onclick="view_staff_chart(); return false;"
                                class="mright5 btn btn-danger pull-left display-block">
                                <?php echo _l('Hierarquia'); ?>
                            </a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 pull-right hide">
                                <input type="text" id="staff_dep_tree" name="staff_dep_tree" class="selectpicker"
                                    placeholder="<?php echo _l('hr_team_manage'); ?>" autocomplete="off">
                                <input type="hidden" name="staff_tree" id="staff_tree" />
                            </div>

                            <div class="col-md-3 leads-filter-column">
                                <select name="conselho" id="conselho_staff" class="form-control">
                            ...
                            <div class="col-md-3 leads-filter-column">
                                <select name="pelorio" id="pelorio_staff" class="form-control">
                                    <option value="">Pelorio</option>
                            ...
                            <div class="col-md-3 leads-filter-column">
                                <select name="direcao" id="direcao_staff" class="form-control">
                                    <option value="">Direções</option>
                            ...
                            <div class="col-md-3 leads-filter-column">
                                <select name="departamento" id="departamento_staff" class="form-control">
                            ...
                            <div class="col-md-3 leads-filter-column">
                                <select name="seccao" id="seccao_staff" class="form-control">
                                    <option value="">Secções</option>
                            ...
                            <div class="col-md-3 pull-right">
                                <select name="status_work[]" class="selectpicker" multiple="true" id="status_work"
                                    data-width="100%" data-none-selected-text="<?php echo _l('hr_status_label'); ?>">
                                    <option value="<?php echo 'working' ?>"><?php echo _l('hr_working'); ?></option>
                                    <option value="<?php echo 'maternity_leave'; ?>">
                                        <?php echo _l('hr_maternity_leave'); ?></option>
                                    <option value="<?php echo 'inactivity'; ?>"><?php echo _l('hr_inactivity'); ?>
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-3 pull-right">
                                <select name="staff_role[]" class="selectpicker" multiple="true" id="staff_role"
                                    ...
                                    <option value="<?php echo new_html_entity_decode($value['position_id']); ?>">
                                        <?php echo new_html_entity_decode($value['position_name']) ?></option>
                                    <?php }
									?>
                                </select>
                            </div>
                            <!-- <div class="col-md-3 leads-filter-column pull-right">
                                <select name="hr_profile_deparment" class="selectpicker" id="hr_profile_deparment"
                                    data-width="100%" data-live-search="true"
                                    data-none-selected-text="<?php echo _l('departments'); ?>">
                                    <option value=""></option>
                                    <?php 
									foreach ($departments as $value) { ?>
                                    <option value="<?php echo new_html_entity_decode($value['departmentid']); ?>">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="modal bulk_actions" id="table_staff_bulk_actions" tabindex="-1"
                                    role="dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-danger"
                                                    data-dismiss="modal"><?php echo _l('hr_cancel'); ?></button>
                                ...
                                <a href="#" onclick="staff_bulk_actions(); return false;" data-toggle="modal"
                                    data-table=".table-table_staff" data-target="#leads_bulk_actions"
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger"
                    data-dismiss="modal"><?php echo _l('hr_cancel'); ?></button>
                <button type="submit" class="btn btn-success"><?php echo _l('hr_confirm'); ?></button>
            </div>
        </div>
        <?php echo form_close(); ?>
    </div>
