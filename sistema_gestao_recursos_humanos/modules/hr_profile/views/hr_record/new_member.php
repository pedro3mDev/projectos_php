        ...
        <div class="row">
            <div class="col-md-6">
                <a class="dashboard-link" href="" style="font-size: 16px; color: #333;">
                    Gestão de Integração / Funcionários / Novo Membro
                </a>
            </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="modal-body">
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active">
                                    <a href="#tab_staff_profile" aria-controls="tab_staff_profile" role="tab"
                                        data-toggle="tab">
                                        <?php echo _l('Perfil do Funcionário'); ?>
                                    </a>
                                </li>
                                <li role="presentation">
                                    <a href="#tab_staff_contact" aria-controls="tab_staff_contact" role="tab"
                                        data-toggle="tab">
                                        <?php echo _l('Outras Informações'); ?>
                                    </a>
                                </li>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group" app-field-wrapper="staff_identifi">
                                                <label for="staff_identifi"
                                                    class="control-label"><?php echo _l('hr_staff_code'); ?></label>
                                                <input type="text" id="staff_identifi" name="staff_identifi"
                                                    class="form-control"
                                                    value="<?php echo new_html_entity_decode($hr_codes) ?>"
                                                    aria-invalid="false" <?php if (!is_admin() && !has_permission('hrm_hr_records', '', 'edit') && !has_permission('hrm_hr_records', '', 'create')) {
																																																																																													echo 'disabled';
																																																																																												}  ?>>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="sex"
                                                    class="control-label"><?php echo _l('hr_sex'); ?></label>
                                                <select name="sex" class="selectpicker" id="sex" data-width="100%"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group" app-field-wrapper="email">
                                                ...
                                                <input type="email" id="email" name="email" class="form-control"
                                                    autocomplete="off"
                                                    value="<?php echo new_html_entity_decode($value) ?>" <?php if (!is_admin() && !has_permission('hrm_hr_records', '', 'edit') && !has_permission('hrm_hr_records', '', 'create')) {
																																																																																		echo 'disabled';
																																																																																	}  ?>>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="workplace"
                                                    class="control-label"><?php echo _l('hr_hr_workplace'); ?></label>
                                                <select name="workplace" class="selectpicker" id="workplace"
                                                    data-width="100%"
                                                    data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                                    <option value=""></option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="status_work"
                                                    class="control-label"><?php echo _l('hr_status_work'); ?></label>
                                                <select name="status_work" class="selectpicker" id="status_work"
                                                    data-width="100%"
                                                    data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="job_position"
                                                    class="control-label"><?php echo _l('hr_hr_job_position'); ?></label>
                                                <select name="job_position" class="selectpicker" id="job_position"
                                                    ...
                                                    <option
                                                        value="<?php echo new_html_entity_decode($p['position_id']); ?>" <?php if (isset($member) && $member->job_position == $p['position_id']) {
																																																				echo 'selected';
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="literacy"
                                                    class="control-label"><?php echo _l('hr_hr_literacy'); ?></label>
                                                <select name="literacy" id="literacy" class="selectpicker"
                                                    data-width="100%"
                                                    data-none-selected-text="<?php echo _l('hr_not_required'); ?>">
                                                    <option value=""></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="default_language" data-live-search="true"
                                                    ...
                                                    <?php foreach ($this->app->get_available_languages() as $availableLanguage) {
														...
														?>
                                                    <option
                                                        value="<?php echo new_html_entity_decode($availableLanguage); ?>"
                                                        <?php echo new_html_entity_decode($selected); ?>>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="default_language"
                                                    class="control-label"><?php echo _l('Conselho'); ?></label>
                                                <select name="conselho_id" data-live-search="true" id="conselho"
                                                    class="form-control selectpicker"
                                                    data-none-selected-text="<?php echo _l('Conselho'); ?>">
                                                    <option value=""><?php echo _l('Selecione Conselho'); ?></option>
                                                    <?php

														// foreach ($opt_conselhos as $availableLanguage) {
														foreach ($opt_conselhos as $conselho) {
															$selected = '';
															if (isset($staff)) {
																if ($staff[0]["conselho_id"] == $conselho["id"]) {
																	$selected = 'selected';
																}
															}
														?>
                                                    <option
                                                        value="<?php echo new_html_entity_decode($conselho["id"]); ?>"
                                                        <?php echo new_html_entity_decode($selected); ?>>
                                                        <?php echo ucfirst($conselho["nome"]); ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            <?php } ?>
                                        ...
                                        <div class="col-md-6">
                                            <?php if (get_option('disable_language') == 0) { ?>
                                            <div class="form-group">
                                                <label for="peloriosSelect"
                                                    class="control-label"><?php echo _l('Pelório'); ?></label>
                                                <select name="pelorio_id" data-live-search="true" id="peloriosSelect"
                                                    class="form-control ">
                                                    <option value=""><?php echo _l('Selecione Pelorios'); ?></option>


                                                    <?php
														// foreach ($opt_conselhos as $availableLanguage) {
														foreach ($opt_pelorios as $pelorio) {
															$selected = '';
															if (isset($staff)) {
																if ($staff[0]["pelorio_id"] == $pelorio["id"]) {
																	$selected = 'selected';
																}
															}
														?>
                                                    <option
                                                        value="<?php echo new_html_entity_decode($pelorio["id"]); ?>"
                                                        <?php echo new_html_entity_decode($selected); ?>>
                                                        <?php echo ucfirst($pelorio["nome"]); ?></option>
                                                    <?php } ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <?php if (get_option('disable_language') == 0) { ?>
                                            <div class="form-group">
                                                <label for="direcoesSelect"
                                                    class="control-label"><?php echo _l('Direção'); ?></label>
                                                <select name="direcao_id" data-live-search="true" id="direcoesSelect"
                                                    class="form-control "
                                                    data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                                    <option value=""><?php echo _l('Selecione a direção'); ?></option>


                                                    <?php
														// foreach ($opt_conselhos as $availableLanguage) {
														foreach ($opt_direcoes as $direcao) {
															$selected = '';
															if (isset($staff)) {
																if ($staff[0]["direcao_id"] == $direcao["id"]) {
																	$selected = 'selected';
																}
															}
														?>
                                                    <option
                                                        value="<?php echo new_html_entity_decode($direcao["id"]); ?>"
                                                        <?php echo new_html_entity_decode($selected); ?>>
                                                        <?php echo ucfirst($direcao["nome"]); ?></option>
                                                    <?php } ?>
                                        ...
                                        <div class="col-md-6">
                                            <?php if (get_option('disable_language') == 0) { ?>
                                            <div class="form-group">
                                                <label for="departamentoSelect"
                                                    class="control-label"><?php echo _l('Departamento'); ?></label>
                                                <select name="departamento_id" data-live-search="true"
                                                    id="departamentoSelect" class="form-control "
                                                    data-none-selected-text="<?php echo _l('departamento'); ?>">
                                                    <option value=""><?php echo _l('Selecione o Departamento'); ?>
                                                    </option>
                                                    ...
                                                    <?php
														...
														?>
                                                    <option
                                                        value="<?php echo new_html_entity_decode($department["departmentid"]); ?>"
                                                        <?php echo new_html_entity_decode($selected); ?>>
                                                        <?php echo ucfirst($department["name"]); ?></option>
                                                    <?php } ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <?php if (get_option('disable_language') == 0) { ?>
                                            <div class="form-group">
                                                <label for="seccoesSelect"
                                                    class="control-label"><?php echo _l('Secção'); ?></label>
                                                <select name="seccao_id" data-live-search="true" id="seccoesSelect"
                                                    class="form-control "
                                                    data-none-selected-text="<?php echo _l('seccoes'); ?>">
                                                    <option value=""><?php echo _l('Selecione a Secção'); ?></option>

                                                    <?php
														// foreach ($opt_conselhos as $availableLanguage) {
														foreach ($opt_seccoes as $seccao) {
															$selected = '';
															if (isset($staff)) {
																if ($staff[0]["seccao_id"] == $seccao["id"]) {
																	$selected = 'selected';
																}
															}
														?>
                                                    <option value="<?php echo new_html_entity_decode($seccao["id"]); ?>"
                                                        <?php echo new_html_entity_decode($selected); ?>>
                                                        <?php echo ucfirst($seccao["nome"]); ?></option>
                                                    <?php } ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="marital_status"
                                                    class="control-label"><?php echo _l('hr_hr_marital_status'); ?></label>
                                                <select name="marital_status" class="selectpicker" id="marital_status"
                                                    data-width="100%"
                                                    data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                                    <option value=""></option>
                                                ...
                                                <tr data-name="<?php echo new_html_entity_decode($feature); ?>">
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php foreach ($permission['capabilities'] as $capability => $name) {
															...
															?>
                                                        <div class="checkbox">
                                                            <input <?php if ($capability == 'view') { ?> data-can-view
                                                                <?php } ?> <?php if ($capability == 'view_own') { ?>
                                                                data-can-view-own <?php } ?>
                                                                <?php if (is_array($name) && isset($name['not_applicable']) && $name['not_applicable']) { ?>
                                                                data-not-applicable="true" <?php } ?> type="checkbox"
                                                            ...
                                                            <label
                                                                for="<?php echo new_html_entity_decode($feature . '_' . $capability); ?>">
                            ...
                            <div class="modal-footer">
                                <a href="<?php echo admin_url('hr_profile/staff_infor'); ?>"
                                    class="btn btn-danger mr-2 "><?php echo _l('hr_cancel'); ?></a>
