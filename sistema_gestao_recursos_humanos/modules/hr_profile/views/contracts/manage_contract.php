        ...
        <div class="row">
            <div class="col-md-6">
                <a class="dashboard-link" href="" style="font-size: 16px; color: #333;">
                    Gestão de Integração / Contractos
                </a>
            </div>
            ...
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="_buttons">
                            <a href="<?php echo admin_url('hr_profile/contract'); ?>"
                                class="btn btn-primary pull-left display-block mright5"><?php echo _l('new_contract'); ?></a>

                            <a href="<?php echo admin_url('hr_profile/import_xlsx_contract'); ?>"
                                class=" btn mright5 btn-default pull-left hide">
                            ...
                            <ul class="dropdown-menu dropdown-menu-left width300 height500">
                                ...
                                <li>
                                    <a href="#" data-cview="all"
                                        onclick="dt_custom_view('','.table-table_contract',''); return false;">
                                        <?php echo _l('contracts_view_all'); ?>
                                    </a>
                                </li>
                                <li class="filter-group" data-filter-group="status">
                                    <a href="#" data-cview="draft"
                                        onclick="dt_custom_view('draft','.table-table_contract','draft'); return false;">
                                        <?php echo _l('hr_hr_draft'); ?>
                                    </a>
                                </li>
                                <li class="filter-group" data-filter-group="status">
                                    <a href="#" data-cview="valid"
                                        onclick="dt_custom_view('valid','.table-table_contract','valid'); return false;">
                                        <?php echo _l('hr_hr_valid'); ?>
                                    </a>
                                </li>
                                <li class="filter-group" data-filter-group="status">
                                    <a href="#" data-cview="invalid"
                                        onclick="dt_custom_view('invalid','.table-table_contract','invalid'); return false;">
                                        <?php echo _l('hr_hr_expired'); ?>
                                    </a>
                                </li>
                                <li class="filter-group" data-filter-group="status">
                                    <a href="#" data-cview="hr_contract_is_about_to_expire"
                                        onclick="dt_custom_view('hr_contract_is_about_to_expire','.table-table_contract','hr_contract_is_about_to_expire'); return false;">
                                        <?php echo _l('hr_contract_is_about_to_expire'); ?>
                                    </a>
                                </li>
                                <li class="filter-group" data-filter-group="status">
                                    <a href="#" data-cview="hr_overdue_contract"
                                        onclick="dt_custom_view('hr_overdue_contract','.table-table_contract','hr_overdue_contract'); return false;">
                                ...
                                <li class="dropdown-submenu pull-left">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-left">
                                        ...
                                        <li><a href="#"
                                                data-cview="contracts_by_staff_<?php echo new_html_entity_decode($s['staffid']); ?>"
                                                onclick="dt_custom_view('contracts_by_staff_<?php echo new_html_entity_decode($s['staffid']); ?>','.table-table_contract','contracts_by_staff_<?php echo new_html_entity_decode($s['staffid']); ?>'); return false;">
                                ...
                                <li>
                                    <a href="#"
                                        data-cview="contracts_by_type_<?php echo new_html_entity_decode($type['id_contracttype']); ?>"
                                        onclick="dt_custom_view('contracts_by_type_<?php echo new_html_entity_decode($type['id_contracttype']); ?>','.table-table_contract','contracts_by_type_<?php echo new_html_entity_decode($type['id_contracttype']); ?>'); return false;">
                                ...
                                <li class="filter-group" data-filter-group="duration">
                                    <a href="#"
                                        data-cview="contracts_by_duration_<?php echo new_html_entity_decode($type['duration']).'_'.$type['unit']; ?>"
                                        onclick="dt_custom_view('contracts_by_duration_<?php echo new_html_entity_decode($type['duration']).'_'.$type['unit']; ?>','.table-table_contract','contracts_by_duration_<?php echo new_html_entity_decode($type['duration']).'_'.$type['unit']; ?>'); return false;">
                        ...
                        <div class="_buttons">
                            <a href="#" class="btn btn-default pull-right btn-with-tooltip toggle-small-view hidden-xs"
                                onclick="toggle_contract_view('.table-table_contract','#hrm_contract'); return false;"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 leads-filter-column">
                                <select name="pelorio" id="pelorio" data-live-search="true" class="selectpicker"
                                    data-actions-box="true" data-width="100%" data-none-selected-text="Pelorios">
                                    <option value=""></option>
                                    <?php foreach($pelorios as $s) { ?>
                                    <option value="<?php echo new_html_entity_decode($s['id']); ?>">
                                        <?php echo new_html_entity_decode($s['nome']); ?>
                                    </option>
                                    <?php } ?>
                            ...
                            <div class="col-md-3 leads-filter-column">
                                <select name="direcao" id="direcao" data-live-search="true" class="selectpicker"
                                    data-actions-box="true" data-width="100%" data-none-selected-text="Direções">
                                    <option value=""></option>
                            ...
                            <div class="col-md-3 leads-filter-column">
                                <select name="departamento" id="departamento" data-live-search="true"
                                    class="selectpicker" data-actions-box="true" data-width="100%"
                                    data-none-selected-text="Departamento">
                                    <option value=""></option>
                            ...
                            <div class="col-md-3 leads-filter-column">
                                <select name="seccao" id="seccao" data-live-search="true" class="selectpicker"
                                    data-actions-box="true" data-width="100%" data-none-selected-text="Secções">
                                    <option value=""></option>
                            ...
                            <div class="col-md-3 leads-filter-column">
                                <select name="staff[]" id="staff" data-live-search="true" class="selectpicker"
                                    multiple="true" data-actions-box="true" data-width="100%"
                                    data-none-selected-text="<?php echo _l('als_staff'); ?>">
                                    <?php foreach($staff as $s) { ?>
                                    <option value="<?php echo new_html_entity_decode($s['staffid']); ?>">
                                        <?php echo new_html_entity_decode($s['firstname'].' '. $s['lastname']); ?>
                                    </option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-12 left-column" id="small-table">
                                ...
                                <a href="#" onclick="staff_bulk_actions(); return false;" data-toggle="modal"
                                    data-table=".table-table_contract" data-target="#leads_bulk_actions"
