...
$aColumns = [
	...
	'conselho_id',
	'pelorio_id',
	db_prefix().'staff.direcao_id',
	'team_manage',
	db_prefix().'staff.seccao_id',
	'sex',
...
$result = data_tables_init($aColumns, $sIndexColumn, $sTable, $join, $where, [
	...
	'pelorio_id',
	db_prefix().'staff.direcao_id',
	db_prefix().'staff.departamento_id',
	db_prefix().'staff.seccao_id',
	'staff_identifi',
	'profile_image',
	'lastname',
...
foreach ($rResult as $aRow) {
	...
	for ($i = 0; $i < count($aColumns); $i++) {
		...
		elseif ($aColumns[$i] == 'conselho_id') {
			$_data = get_hr_conselho_name($aRow['conselho_id']);
		} elseif ($aColumns[$i] == 'pelorio_id') {
			$_data = get_hr_pelorio_name($aRow['pelorio_id']);
		}
		elseif ($aColumns[$i] == db_prefix().'staff.direcao_id') {
			$_data = get_hrst_direcao_name($aRow['direcao_id']);
		}
		...
		elseif ($aColumns[$i] == db_prefix().'staff.seccao_id') {
			$_data = get_hrst_seccao_name($aRow['seccao_id']);
		}
