...
function hr_profile_job_position_by_staff($staffid){
	...
	function get_pelorio_by_id($id){
		$CI = &get_instance();
		return $CI->db->query('SELECT * FROM '.db_prefix().'hr_pelorios WHERE id = '.$id)->row();
	}
	function get_direcao_by_id($id){
		$CI = &get_instance();
		return $CI->db->query('SELECT * FROM '.db_prefix().'hr_direcoes WHERE id = '.$id)->row();
	}
	function get_departments_by_id($id){
		$CI = &get_instance();
		return $CI->db->query('SELECT * FROM '.db_prefix().'departments WHERE departmentid = '.$id)->row();
	}

	function get_hr_conselho_name($id){
		$CI           = & get_instance();
		if($id != 0){
			$CI->db->where('id',$id);
			$dpm = $CI->db->get(db_prefix().'hr_conselhos')->row();
			if($dpm->nome){
				return $dpm->nome;
			}else{
				return '';
	...
	function get_hr_pelorio_name($id){
		$CI           = & get_instance();
		if($id != 0){
			$CI->db->where('id',$id);
			$dpm = $CI->db->get(db_prefix().'hr_pelorios')->row();
			if($dpm->nome){
				return $dpm->nome;
			}else{
				return '';
	...
	function get_hr_direcao_name($id){
		$CI           = & get_instance();
		if($id != 0){
			$CI->db->where('id',$id);
	...
	function get_hr_seccao_name($id){
		$CI           = & get_instance();
		if($id != 0){
			$CI->db->where('id',$id);
	...
	function get_hrst_direcao_name($id){
		$CI           = & get_instance();
		if($id != 0){
			$CI->db->where('id',$id);
			$dpm = $CI->db->get(db_prefix().'hr_direcoes')->row();
	...
	function get_hrst_seccao_name($id){
		$CI           = & get_instance();
		if($id != 0){
			$CI->db->where('id',$id);
			$dpm = $CI->db->get(db_prefix().'hr_seccoes')->row();
