		...
		<div class="panel-body no-border doc-btn-tool">
			...
			<?php if($item->creator_id == $user_id && $item->creator_type == 'customer'){ ?>
				...
				<?php if($item->approve == -1 || $item->approve == 1 || $item->approve == 2){ 
					...
					?>
					<a href="<?php echo site_url('document_management/document_management_client/detail_approve/'.$item->hash); ?>" class="btn w100 mtop5 mbot5<?php echo htmldecode($color_class); ?>" >
			...
			<?php if($item->creator_id == $user_id && $item->creator_type == 'customer'){ ?>
				...
				<?php if($item->sign_approve == -1 || $item->sign_approve == 1 || $item->sign_approve == 2){ 
					...
					?>
					<a href="<?php echo site_url('document_management/document_management_client/detail_sign_approve/'.$item->hash); ?>" class="btn w100 mtop5 mbot5<?php echo htmldecode($color_class); ?>" >
...
<div class="modal send_request_approve_modal" id="send_request_approve_modal" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<?php echo form_open_multipart(site_url('document_management/document_management_client/send_request_approve/'.$parent_id),array('id'=>'form_upload_file')); ?>              
			<div class="modal-body">
