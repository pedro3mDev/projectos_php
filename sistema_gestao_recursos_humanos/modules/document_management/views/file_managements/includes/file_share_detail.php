<?php if(isset($item) && !check_share_permission($item->id, 'upload_only')){ 
	?>
	<div class="row">
		<div class="col-md-8">
			...
			<table class="table">
				...
				<?php if(!check_share_permission($item->id, 'preview')){ 
					$data_file_selected = [];
		...
		<div class="col-md-4">
			...
			<?php if(check_share_permission($item->id, 'editor')){ ?>
	...
	<div class="panel-default no-border">
		<div class="panel-body no-border">
			...
			<hr>
			<?php 
			if(check_share_permission($item->id, 'viewer') || check_share_permission($item->id, 'editor')){ ?>
			...
			<?php if(!(strpos($item->name, '.docx') === false) || !(strpos($item->name, '.doc') === false)){ ?>
				<?php if(check_share_permission($item->id, 'viewer') || check_share_permission($item->id, 'editor')){ ?>
					<a href="<?php echo admin_url('document_management/preview?id='.$item->id) ?>" target="_blank" class="btn btn-default w100 mtop5 mbot5">
