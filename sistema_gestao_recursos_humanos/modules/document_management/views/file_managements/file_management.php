	...
	<div class="content">
        ...
        <div class="row">
            ...
            <a class="dashboard-link" href="" style="font-size: 16px; color: #333;">
                Gestão Documental / Gerenciamento de Arquivos
            </a>
            </div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="col-md-3">
									<h4>
									<?php 
										if ($share_to_me == 0 && $my_approval  == 0 && $electronic_signing == 0) {
											echo htmldecode($title);
										}elseif ($share_to_me != 0) {
											echo htmldecode('Compartilhar Comigo');
										}elseif ($my_approval  != 0 ) {
											echo htmldecode('Minha Aprovação');
										}elseif ($electronic_signing != 0) {
											echo htmldecode('Assinaturas Eletrônicas');
										}
									 ?>
