...
<div>
    ...
    <table class="table dt-table">
        <thead>
            <th width="30%"><?php echo _l('plano'); ?></th>
            <th width="30%"><?php echo _l('description'); ?></th>
            <th><?php echo _l('options'); ?></th>
        </thead>
        <tbody>
            <?php foreach($plano as $c){ ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="javascript:;" data-id="<?= $c['id'] ?>"
                        data-plano="<?= html_entity_decode($c['nome']) ?>"
                        data-descricao="<?= html_entity_decode($c['descricao']) ?>"
                        class="btn btn-default btn-icon btn_edit_plano">
                        <i class="fa fa-edit"></i>
                    </a>
                    <?php } ?>

                    <?php if(is_admin() || has_permission('psl_configuracoes','','delete')){ ?>
                    <a onclick="return confirm('Tens certteza que desejas eliminar este plano?');"
                        href="<?php echo admin_url('Plan_forca_trabalho/delete_plano/'.$c['id']); ?>"
    ...
    <div class="modal" id="modal_add" tabindex="-1" role="dialog">
        <div class="modal-dialog w-25">
            <?= form_open(admin_url('Plan_forca_trabalho/add_plano'), array('method' => 'post')) ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form">
                                <div class="col-md-12">
                                    <?php echo render_input('plano','plano'); ?>
                                </div>
                                <div class="col-md-12">
    ...
    <?= form_open(admin_url('Plan_forca_trabalho/editar_plano'), array('method' => 'post', 'id' => 'form_edit_plano')) ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form">
                                <div class="col-md-12">
                                    <?php echo render_input('e_plano','plano'); ?>
                                </div>
                                <div class="col-md-12">
