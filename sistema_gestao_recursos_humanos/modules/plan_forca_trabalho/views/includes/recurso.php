...
<div>
    ...
    <table class="table dt-table">
        <thead>
            <th width="30%"><?php echo _l('recurso'); ?></th>
            <th width="30%"><?php echo _l('description'); ?></th>
            <th><?php echo _l('options'); ?></th>
        </thead>
        <tbody>
            <?php foreach($recurso as $c){ ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="javascript:;" data-id="<?= $c['id'] ?>"
                        data-recurso="<?= html_entity_decode($c['nome']) ?>"
                    ...
                    <a onclick="return confirm('Tens certteza que desejas eliminar este recurso?');"
                        href="<?php echo admin_url('Plan_forca_trabalho/delete_recurso/'.$c['id']); ?>"
    ...
    <div class="modal" id="modal_add" tabindex="-1" role="dialog">
        <div class="modal-dialog w-25">
            <?= form_open(admin_url('Plan_forca_trabalho/add_recurso'), array('method' => 'post')) ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form">
                                <div class="col-md-12">
                                    <?php echo render_input('recurso','recurso'); ?>
                                </div>
                                <div class="col-md-12">
    ...
    <?= form_open(admin_url('Plan_forca_trabalho/editar_recurso'), array('method' => 'post', 'id' => 'form_edit_recurso')) ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form">
                                <div class="col-md-12">
                                    <?php echo render_input('e_recurso','recurso'); ?>
                                </div>
                                <div class="col-md-12">
