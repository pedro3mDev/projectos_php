...
<div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a onclick="return confirm('Tens certteza que desejas eliminar este competencia?');"
                        href="<?php echo admin_url('Plan_forca_trabalho/delete_competencia/'.$c['id']); ?>"
    ...
    <div class="modal" id="modal_add" tabindex="-1" role="dialog">
        <div class="modal-dialog w-25">
            <?= form_open(admin_url('Plan_forca_trabalho/add_competencia'), array('method' => 'post')) ?>
    ...
    <?= form_open(admin_url('Plan_forca_trabalho/editar_competencia'), array('method' => 'post', 'id' => 'form_edit_competencia')) ?>
