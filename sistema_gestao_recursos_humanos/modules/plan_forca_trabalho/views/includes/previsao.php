...
<div>
    ...
    <table class="table dt-table">
        <thead>
            <th width="30%"><?php echo _l('previsao'); ?></th>
            <th width="30%"><?php echo _l('description'); ?></th>
            <th><?php echo _l('options'); ?></th>
        </thead>
        <tbody>
            <?php foreach($previsao as $c){ ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="javascript:;" data-id="<?= $c['id'] ?>"
                        data-previsao="<?= html_entity_decode($c['nome']) ?>"
                        data-descricao="<?= html_entity_decode($c['descricao']) ?>"
                        class="btn btn-default btn-icon btn_edit_previsao">
                        <i class="fa fa-edit"></i>
                    </a>
                    <?php } ?>

                    <?php if(is_admin() || has_permission('psl_configuracoes','','delete')){ ?>
                    <a onclick="return confirm('Tens certteza que desejas eliminar este previsao?');"
                        href="<?php echo admin_url('Plan_forca_trabalho/delete_previsao/'.$c['id']); ?>"
    ...
    <div class="modal" id="modal_add" tabindex="-1" role="dialog">
        <div class="modal-dialog w-25">
            <?= form_open(admin_url('Plan_forca_trabalho/add_previsao'), array('method' => 'post')) ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form">
                                <div class="col-md-12">
                                    <?php echo render_input('previsao','previsao'); ?>
                                </div>
                                <div class="col-md-12">
    ...
    <?= form_open(admin_url('Plan_forca_trabalho/editar_previsao'), array('method' => 'post', 'id' => 'form_edit_previsao')) ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form">
                                <div class="col-md-12">
                                    <?php echo render_input('e_previsao','previsao'); ?>
                                </div>
                                <div class="col-md-12">
