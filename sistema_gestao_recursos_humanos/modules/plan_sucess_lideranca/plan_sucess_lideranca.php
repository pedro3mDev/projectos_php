 ...
 function plan_sucess_lideranca_module_init_menu_items() {
    ...
    if (has_permission('plan_sucess_lideranca', '', 'view') && $is_plan_sucess_lideranca_module) {
        ...
        $submenus = [ 
            ...
            ['slug' => 'plan_sucess_lideranca-identificacao', 'name' => 'Identificação', 'icon' => 'fa fa-id-badge', 'href' => 'identificacao_resultado', 'position' => 2], 
            ['slug' => 'plan_sucess_lideranca-planeamento', 'name' => 'Planeamento', 'icon' => 'fa fa-calendar-check', 'href' => 'planeamento_resultado', 'position' => 3], 
            ['slug' => 'plan_sucess_lideranca-desenvolvimento', 'name' => 'Desenvolvimento', 'icon' => 'fa fa-chart-line', 'href' => 'desenvolvimento_resultado', 'position' => 4], 
            ...
            ['slug' => 'plan_sucess_lideranca-analise_risco', 'name' => 'Análise de Risco', 'icon' => 'fa fa-exclamation-triangle', 'href' => 'analise_risco_resultado', 'position' => 7], 
            ['slug' => 'plan_sucess_lideranca-engajamento', 'name' => 'Engajamento', 'icon' => 'fa fa-users', 'href' => 'engajamento_resultado', 'position' => 8], 
