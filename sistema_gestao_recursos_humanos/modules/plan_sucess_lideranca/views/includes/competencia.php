...
<div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a onclick="return confirm('Tens certteza que desejas eliminar esta competencia?');"
                        href="<?php echo admin_url('plan_sucess_lideranca/delete_competencia/'.$c['id']); ?>"
    ...
    <div class="modal" id="modal_add" tabindex="-1" role="dialog">
        <div class="modal-dialog w-25">
            <?= form_open(admin_url('plan_sucess_lideranca/add_competencia'), array('method' => 'post')) ?>
    ...
    <?= form_open(admin_url('plan_sucess_lideranca/editar_competencia'), array('method' => 'post', 'id' => 'form_edit_competencia')) ?>
