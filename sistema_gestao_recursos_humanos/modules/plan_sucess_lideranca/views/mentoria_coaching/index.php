...
<div id="wrapper">
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-10">
                <a class="dashboard-link" href="" style="font-size: 16px; color: #333;">
                    Plano de Sucessão e Liderança / Mentoria e Coaching
                </a>
            </div>
        ...
        <?php require 'modules/plan_sucess_lideranca/views/mentoria_coaching/cards.php'; ?>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <h4 class="font-bold no-margin">
                                    ...
                                    Mentoria e Coaching para Sucessores
                                </h4>
                                <hr />
                            </div>
                        </div>
                        ...
                        <table class="table table-hover table-bordered table-responsive dt-table">
                            ...
                            <tbody>
                                <?php foreach($mentoria as $item) : ?>
                                <tr>
                                    <td class="text-capitalize">
                                        <?= htmlspecialchars($item['p_nome_mentor'] .' '.$item['s_nome_mentor']); ?>
                                    </td>
                                    <td class="text-capitalize">
                                        <?= htmlspecialchars($item['p_nome_mentorado'] .' '.$item['s_nome_mentorado']); ?>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo admin_url('plan_sucess_lideranca/mentoria_aprovar/'. $item['id']); ?>"
                                            class="btn btn-success" style="color: white;">
                                            Aprovar
                                        </a>
                                        <a onclick="return confirm('Tens certeza que desejas rejeitar?');"
                                            href="<?php echo admin_url('plan_sucess_lideranca/mentoria_rejeitar/'. $item['id']); ?>"
                                            class="text-white btn btn-danger"
                                            style="background-color:#FFA500; border-color:#FFA500; color:#fff;">
                                            Rejeitar
                                        </a>
                                        <?php endif ?>
                                        <a href="<?php echo admin_url('plan_sucess_lideranca/mentoria_visualizar_mentoria/'. $item['id'])?>"
...
<div class="modal" id="modal_add" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-md">
        <?= form_open(admin_url('plan_sucess_lideranca/adicionar_mentoria'), array('method' => 'post')) ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <?php
                            $selectedStaff = '';
                            echo render_select('mentorado', $staffs, ['staffid', ['firstname', 'lastname']], 'Mentorado<span class="text-danger">*</span>', $selectedStaff, [], [], '', '', true);
                            ?>
                        </div>
                        <div class="form-group">
...
<?= form_open(admin_url('plan_sucess_lideranca/editar_mentoria'), array('method' => 'post', 'id' => 'form_edit_mentoria')) ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <?php
                            $selectedStaff = '';
                            echo render_select('e_mentorado', $staffs, ['staffid', ['firstname', 'lastname']], 'Mentorado<span class="text-danger">*</span>', $selectedStaff, [], [], '', '', true);
                            ?>
                        </div>
                        <div class="form-group">
...
<script>
// programa_lideranca
$('.btn_edit_mentoria').click(function() {
    let mentor = $(this).attr('data-mentor');
    let mentorado = $(this).attr('data-mentorado');
    let feedback = $(this).attr('data-feedback');
    let aprovadores = $(this).attr('data-aprovadores');

    let id = $(this).attr('data-id');

    let url = "<?= admin_url('plan_sucess_lideranca/editar_mentoria') ?>/" + id;
    $('#form_edit_mentoria').attr('action', url);

    $('select[name="e_mentor"]').selectpicker('val', mentor);
    $('select[name="e_mentorado"]').selectpicker('val', mentorado);
