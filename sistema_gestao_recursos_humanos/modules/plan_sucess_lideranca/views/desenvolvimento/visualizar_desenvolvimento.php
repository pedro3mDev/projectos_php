    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                Plano de Sucessão e Liderança / Desenvolvimento / Visualizar
                </a>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="no-margin font-bold">
                            <i class="fa fa-address-card-o" aria-hidden="true"></i> Visualizar Desenvolvimento de Liderança
                        </h4>
                        <hr />
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table border table-striped">
                            <tbody>
                                ...
                                <tr class="project-overview">
                                    <td class="bold" width="40%">Data Início</td>
                                    <td><?= $programa['data_inicio']?></td>
                                </tr>
                                <tr class="project-overview">
                                    <td class="bold" width="40%">Data Fim</td>
