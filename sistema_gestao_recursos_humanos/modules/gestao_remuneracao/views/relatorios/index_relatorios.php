...
<div id="wrapper">
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-10">
                <a class="dashboard-link" href="" style="font-size: 16px; color: #333;">
                    Gestão de Remuneração / Relatório / Relatório de Salário
                </a>
            </div>
        ...
        <?php require 'modules/gestao_remuneracao/views/relatorios/cards.php'; ?>
        </br>
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-hover table-bordered table-responsive dt-table">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($relatorio_salario as $relatorio_salarios): ?>
                                    <tr>
                                        <td> <a href="#"><?= htmlspecialchars($relatorio_salarios['descricao']); ?></a>
                                        </td>
                                        <td> <a
                                                href="#"><?= date('d/m/Y', strtotime($relatorio_salarios['data_geracao'])); ?></a>
                                        </td>
                                        <td>
                                            <a href="<?php echo admin_url('gestao_remuneracao/relatorios_visualizar_relatorio_salario/'. $relatorio_salarios['id']) ?>"
                                                class="btn btn-success btn-icon">
                                                <i style="color: white;" class="fa fa-eye"></i>
                                            </a>
                                            <a href="#" class="btn btn-default btn-edit-relatorio_salario"
                                                data-id="<?= $relatorio_salarios['id']; ?>"
                                                data-descricao="<?= $relatorio_salarios['descricao']; ?>"
                                                data-data_geracao="<?= $relatorio_salarios['data_geracao']; ?>"
                                                data-toggle="modal" data-target="#editar">
                                                <i class="fa fa-edit"></i>
                                            </a>

                                            <a onclick="return confirm('Tem certeza que deseja excluir?');"
                                                href="<?= base_url('gestao_remuneracao/delete_relatorio_salario/' . $relatorio_salarios['id']); ?>"
...
<div class="modal" id="modal_add" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-md">
        <?php echo form_open(admin_url('gestao_remuneracao/add_relatorio_salario'), array('method' => 'post')); ?>
...
<?= form_open(admin_url('gestao_remuneracao/editar_relatorio_salario'), array('method' => 'post', 'id' => 'form_edit_relatorio_salario')) ?>
...
<script>
    $(document).ready(function () {
        $(document).on('click', '.btn-edit-relatorio_salario', function () {
            let id = $(this).data('id');
