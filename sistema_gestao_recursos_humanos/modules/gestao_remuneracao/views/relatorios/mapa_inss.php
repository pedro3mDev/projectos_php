        ...
        <div class="row">
            <div class="col-md-10">
                <a class="dashboard-link" href="" style="font-size: 16px; color: #333;">
                    Gestão de Remuneração / Relatório / Mapa INSS
                </a>
            </div>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <table class="table table-hover table-bordered table-responsive dt-table">
                            ...
                            <tbody>
                                <?php foreach ($mapa_inss as $mapa_insss): ?>
                                    <tr>
                                        <td> <a href="#"><?= htmlspecialchars($mapa_insss['descricao']); ?></a>
                                        </td>
                                        <td> <a href="#"><?= date('d/m/Y', strtotime($mapa_insss['data_envio'])); ?></a>
                                        </td>
                                        <td>
                                            <a href="<?php echo admin_url('gestao_remuneracao/relatorios_visualizar_mapa_inss/'. $mapa_insss['id']) ?>"
                                                class="btn btn-success btn-icon">
                                                <i style="color: white;" class="fa fa-eye"></i>
                                            </a>
                                            <a href="#" class="btn btn-default btn-edit-mapa_inss"
                                                data-id="<?= $mapa_insss['id']; ?>"
                                                data-descricao="<?= $mapa_insss['descricao']; ?>"
                                                data-data_envio="<?= $mapa_insss['data_envio']; ?>" data-toggle="modal"
                                                data-target="#editar">
                                                <i class="fa fa-edit"></i>
                                            </a>

                                            <a onclick="return confirm('Tem certeza que deseja excluir?');"
                                                href="<?= base_url('gestao_remuneracao/delete_mapa_inss/' . $mapa_insss['id']); ?>"
...
<div class="modal" id="modal_add" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-md">
        <?php echo form_open(admin_url('gestao_remuneracao/add_mapa_inss'), array('method' => 'post')); ?>
...
<?= form_open(admin_url('gestao_remuneracao/editar_mapa_inss'), array('method' => 'post', 'id' => 'form_edit_mapa_inss')) ?>
...
<script>
    $(document).ready(function () {
        $(document).on('click', '.btn-edit-mapa_inss', function () {
            let id = $(this).data('id');
