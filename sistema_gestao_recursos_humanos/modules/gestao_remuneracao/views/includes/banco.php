...
<div>
    ...
    <table class="table dt-table">
        <thead>
            <th width="30%"><?php echo _l('banco'); ?></th>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="javascript:;" data-id="<?= $c['id'] ?>"
                        data-banco="<?= html_entity_decode($c['nome']) ?>"
                        data-descricao="<?= html_entity_decode($c['descricao']) ?>"
                        class="btn btn-default btn-icon btn_edit_banco">
                        <i class="fa fa-edit"></i>
                    </a>
                    <?php } ?>

                    <?php if(is_admin() || has_permission('psl_configuracoes','','delete')){ ?>
                    <a onclick="return confirm('Tens certteza que desejas eliminar este banco?');"
                        href="<?php echo admin_url('gestao_remuneracao/delete_banco/'.$c['id']); ?>"
    ...
    <div class="modal" id="modal_add" tabindex="-1" role="dialog">
        <div class="modal-dialog w-25">
            <?= form_open(admin_url('gestao_remuneracao/add_banco'), array('method' => 'post')) ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form">
                                <div class="col-md-12">
                                    <?php echo render_input('banco','banco'); ?>
                                </div>
                                <div class="col-md-12">
    ...
    <?= form_open(admin_url('gestao_remuneracao/editar_banco'), array('method' => 'post', 'id' => 'form_edit_banco')) ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form">
                                <div class="col-md-12">
                                    <?php echo render_input('e_banco','banco'); ?>
                                </div>
                                <div class="col-md-12">
