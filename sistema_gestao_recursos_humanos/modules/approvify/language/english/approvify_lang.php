...
$lang['approvify_action_message'] = 'Leave a message';

$lang['approvify_no_types'] = 'Não há tipos de solicitação disponíveis, por favor, acesse <a href="'.admin_url('approvify/configuracoes').'">Tipos de Aprovação</a> e crie um novo tipo de solicitação ou ative os existentes.';
