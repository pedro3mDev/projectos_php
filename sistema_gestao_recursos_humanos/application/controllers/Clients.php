...
class Clients extends ClientsController
{
    ...
    public function index()
    {
        ...
        $data['dados'] = $this->contar_dados();
        $data['treinemento'] = $this->get_treinamento();
        $this->data($data);
        $this->view('home');
        $this->layout();
    }

    public function get_treinamento() 
    {
        $this->db->select('
           tblpsl_treinamento_lideranca.*,
           tblpsl_programa_lideranca.nome as programa_lideranca
          ');
          $this->db->from('tblpsl_treinamento_lideranca');
          $this->db->join('tblpsl_programa_lideranca', 'tblpsl_programa_lideranca.id = tblpsl_treinamento_lideranca.programa_lideranca_id', 'left');
    ...
    public function contar_dados()
    {
        ...
        $this->db->from('tblgv_pedido_viagem');
