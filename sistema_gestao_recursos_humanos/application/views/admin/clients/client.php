    ...
    <?php } ?>
        ...
        <div class="md:tw-flex md:tw-gap-6">
            ...
            <div
                ...
                <?php if (! isset($client)) {?>
                <!--h4 class="tw-mt-0 tw-font-bold tw-text-lg tw-text-neutral-700" style="color:#00008B;">
                    <?= $title ?>
                </h4-->
                ...
                <div class="panel_s">
                    ...
                    <div class="panel-footer text-right tw-space-x-1" id="profile-save-section">
                        <?php if (! isset($client)) { ?>
                        <button  style="border: 1px solid #FFF;background-color: #66CDAA; color:#fff" class="btn btn-default save-and-add-contact customer-form-submiter">
                            <?= _l('save_customer_and_add_contact'); ?>
                        </button>
                        <?php } ?>
                        <button style="border: 1px solid #FFF;background-color:#00008B;" class="btn btn-primary only-save customer-form-submiter">
                            <?= _l('submit'); ?>
                        </button>
                    </div>
                    <?php } ?>
