...
<div id="wrapper">
    <div class="content">
        ...
        <?php include('C:/laragon/www/perfex_crm/application/views/admin/menu_modulo/menu.php'); ?>
...
echo render_input('default_pass_all', 'default_pass_clients_import', $this->input->post('default_pass_all')); ?>
                                <div class="form-group">
                                    <button type="button" style="color:#fff; border: 1px solid #FFF; background-color: #66CDAA;"
                                        class="btn btn-primary import btn-import-submit"><?= _l('import'); ?></button>
                                    <button type="button" style="background-color: #00008B; color:#fff; border: 1px solid #FFF;"
