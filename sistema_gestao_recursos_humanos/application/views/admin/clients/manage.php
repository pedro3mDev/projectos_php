            ...
            <div class="col-md-12" >
                <?php if (staff_can('view', 'customers') || have_assigned_customers()) {
                    ...
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a  style="color:#333; font-size:16px;" href=""><?= _l('clients'); ?></a></li>
                ...
                <div class="tw-mb-6">
                    ...
                    <div class="tw-grid tw-grid-cols-6 md:tw-grid-cols-3 lg:tw-grid-cols-6 tw-gap-2">
                        <div class="tw-shadow-sm tw-text-sm tw-rounded-lg tw-px-4 tw-py-3 tw-flex-1 tw-flex tw-items-center tw-font-medium"
                        style="padding: 20px; background-color: #fff; border: none; border-bottom: 1px solid red; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1); ">
                            <span class="tw-font-semibold tw-mr-1 rtl:tw-ml-1"  style="font-size: 16px;  color:#333;">
                                <?= total_rows(db_prefix() . 'clients', ($where_summary != '' ? substr($where_summary, 5) : '')); ?>
                            </span>
                            <span
                                class="text-dark tw-truncate sm:tw-text-clip" style="font-size: 16px;  color:#333;"><?= _l('customers_summary_total'); ?>
                            </span>
                        </div>
                        <div class="tw-shadow-sm tw-text-sm tw-rounded-lg tw-px-4 tw-py-3 tw-flex-1 tw-flex tw-items-center tw-font-medium"
                        style="padding: 20px; background-color: #fff; border: none; border-bottom: 1px solid red; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
                            <span class="tw-font-semibold tw-mr-1 rtl:tw-ml-1"  style="font-size: 16px;  color:#333;">
                                <?= total_rows(db_prefix() . 'clients', 'active=1' . $where_summary); ?>
                            </span>
                            <span class="text-success tw-truncate sm:tw-text-clip"  style="font-size: 16px;  color:#333;">
                                <?= _l('active_customers'); ?>
                            </span>
                        </div>
                        <div class="tw-shadow-sm tw-text-sm tw-rounded-lg tw-px-4 tw-py-3 tw-flex-1 tw-flex tw-items-center tw-font-medium"
                        style="padding: 20px; background-color: #fff; border: none; border-bottom: 1px solid red; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
                            <span class="tw-font-semibold tw-mr-1 rtl:tw-ml-1"  style="font-size: 16px;  color:#333;"> 
                                <?= total_rows(db_prefix() . 'clients', 'active=0' . $where_summary); ?>
                            </span>
                            <span class="text-danger tw-truncate sm:tw-text-clip"  style="font-size: 16px;  color:#333;">
                                <?= _l('inactive_active_customers'); ?>
                            </span>
                        </div>
                        <!--div class="tw-shadow-sm tw-text-sm tw-rounded-lg tw-px-4 tw-py-3 tw-flex-1 tw-flex tw-items-center tw-font-medium"
                        style="padding: 20px; background-color: #fff; border: none; border-bottom: 1px solid red; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
                            ...
                            <span
                                class="text-info tw-truncate sm:tw-text-clip"  style="font-size: 16px;  color:#333;"><?= _l('customers_summary_active'); ?></span>
                        </div>
                        <div class="tw-shadow-sm tw-text-sm tw-rounded-lg tw-px-4 tw-py-3 tw-flex-1 tw-flex tw-items-center tw-font-medium"
                        style="padding: 20px; background-color: #fff; border: none; border-bottom: 1px solid red; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
                            <span class="tw-font-semibold tw-mr-1 rtl:tw-ml-1"  style="font-size: 16px;  color:#333;">
                            ...
                            <span
                                class="text-danger tw-truncate sm:tw-text-clip"  style="font-size: 16px;  color:#333;"><?= _l('customers_summary_inactive'); ?></span>
                        </div-->
                        <!--div class="tw-shadow-sm tw-text-sm tw-rounded-lg tw-px-4 tw-py-3 tw-flex-1 tw-flex tw-items-center tw-font-medium"
                        style="padding: 20px; background-color: #fff; border: none; border-bottom: 1px solid red; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
                            <span class="tw-font-semibold tw-mr-1 rtl:tw-ml-1"  style="font-size: 16px;  color:#333;">
                            ...
                            <span class="text-muted tw-truncate" data-toggle="tooltip"
                                data-title="<?= _l('customers_summary_logged_in_today'); ?>"  style="font-size: 16px;  color:#333;">
                                <?php
                                          $contactsTemplate = '';
                ...
                <div class="tw-flex tw-justify-between tw-items-center tw-gap-x-6">
                    <div class="tw-flex tw-justify-between tw-items-center tw-gap-x-1">
                        ...
                        <a href="<?= admin_url('clients/client'); ?>"
                            class="btn btn-primary" style="background-color: #66CDAA; color:#fff; border: 1px solid #FFF;">
                        ...
                        <a href="<?= admin_url('clients/import'); ?>"
                            class="hidden-xs btn btn-default" style="background-color: #00008B; color:#fff; border: 1px solid #FFF;">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button style="background-color: Red; color: #fff; border: 1px solid #FFF;" type="button" class="btn btn-default"
                                            data-dismiss="modal"><?= _l('close'); ?></button>
                                        <a style="background-color: #66CDAA; border: 1px solid #FFF;" href="#" class="btn btn-primary"
