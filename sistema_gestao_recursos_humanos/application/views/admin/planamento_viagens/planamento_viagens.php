        ...
        <div class="tw-max-w-4xl tw-mx-auto">
            <div class="tw-flex tw-justify-between tw-text-neutral-700">
                <h4 class="tw-mt-0 tw-font-bold">
                    ...
                    <br />
                    <small>
                        <?= e($planamento_viagens->form_data->name ?? ''); ?>
                    </small>
                </h4>
                <div>
                    <div class="btn-group">
                        <?php if (staff_can('create', 'planamento') || staff_can('create', 'proposals')) { ?>
                        <span class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="convertDropdown">
                                ...
                                <li>
                                    <a href="#" onclick="convert_planamento_viagens_to('estimate'); return false;">
                                        <?= _l('planamento') ?>
                                    </a>
                                </li>
                                <?php } ?>
                                ...
                                <li>
                                    <a href="#" data-template="proposal"
                                        onclick="convert_planamento_viagens_to('proposal'); return false;">
                                        <?= _l('proposal') ?>
                                    </a>
                                </li>
                                <?php } ?>
                        ...
                        <?php } ?>
                        <?php if (staff_can('edit', 'planamento_viagens')) { ?>
                        <span class="dropdown">
