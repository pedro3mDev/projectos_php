...
<div class="modal fade" id="status" tabindex="-1" role="dialog">
   <div class="modal-dialog">
      <?php echo form_open(admin_url('planamento_viagens/status'), ['id' => 'planamento_viagens-status-form']); ?>
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">
               <span class="edit-title"><?php echo _l('edit_status'); ?></span>
               <span class="add-title"><?php echo _l('planamento_viagens_new_status'); ?></span>
            </h4>
         </div>
         <div class="modal-body">
            <div class="row">
               <div class="col-md-12">
                  ...
                  <?php echo render_input('name', 'planamento_viagens_status_add_edit_name'); ?>
                  <?php echo render_color_picker('color', _l('planamento_viagens_status_color')); ?>
                  <?php echo render_input('statusorder', 'planamento_viagens_status_add_edit_order', total_rows(db_prefix() . 'planamento_viagens_status') + 1, 'number'); ?>
               </div>
            </div>
         </div>
...
<script>
  window.addEventListener('load', function () {
    appValidateForm($("body").find('#planamento_viagens-status-form'), {
        name: 'required'
    }, manage_planamento_viagens_statuses);
