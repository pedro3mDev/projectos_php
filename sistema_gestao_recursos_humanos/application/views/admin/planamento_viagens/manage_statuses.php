            ...
            <div class="col-md-12">
                <div class="tw-mb-2">
                    <a href="#" onclick="new_status(); return false;" class="btn btn-primary">
                        ...
                        <?= _l('planamento_viagenst_new_status'); ?>
                    </a>
                </div>
                    ...
                    <div class="panel-body panel-table-full">
                        ...
                        <table class="table dt-table" data-order-col="1" data-order-type="asc">
                            <thead>
                                ...
                                <th><?= _l('planamento_viagens_status_table_name'); ?>
                                </th>
                                <th><?= _l('options'); ?>
                                </th>
                            </thead>
                                ...
                                <tr>
                                    ...
                                    <td><a href="#" class="tw-font-medium"
                                        ...
                                        <span class="text-muted">
                                            <?= _l('planamento_viagens_table_total', total_rows(db_prefix() . 'planamento_viagens', ['status' => $status['id']])); ?></span>
                                    </td>
                                    <td>
                        ...
                        <?php } else { ?>
                        <p class="no-margin">
                            <?= _l('planamento_viagens_statuses_not_found'); ?>
                        </p>
                        <?php } ?>
                    </div>
                </div>
...
<?php include_once APPPATH . 'views/admin/planamento_viagens/status.php'; ?>
<?php init_tail(); ?>
</body>
